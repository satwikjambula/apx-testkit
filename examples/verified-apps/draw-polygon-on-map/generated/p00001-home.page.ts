...
export class HomePage {
  ...
  /** textarea, "Polygon" */
  get polygon(): ApexItem {
    return new ApexItem(this.page, 'P1_POLYGON');
  }

  /** textField, "Prompt" */
  get prompt(): ApexItem {
    return new ApexItem(this.page, 'P1_PROMPT');
  }

  /** "Draw" */
  async clickDraw(): Promise<void> {
    await buttonByLabel(this.page, 'Draw').click();
  }
}
