...
export class AirportsHeatMapPage {
  static readonly alias = 'airports-heat-map';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AirportsHeatMapPage.alias);
  }
  ...
  /** selectList, "Filter for State" */
  get state(): ApexItem {
    return new ApexItem(this.page, 'P110_STATE');
  }
}
