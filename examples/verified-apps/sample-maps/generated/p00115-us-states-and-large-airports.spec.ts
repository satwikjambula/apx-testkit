/**
 * GENERATED by apx-testgen from pages/p00115-us-states-and-large-airports.apx — DO NOT EDIT.
 ...
 * (./p00115-us-states-and-large-airports.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, states-and-large-airports
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), states-and-large-airports (map).
...
import { UsStatesAndLargeAirportsPage } from './p00115-us-states-and-large-airports.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 115: US States and Large Airports [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new UsStatesAndLargeAirportsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new UsStatesAndLargeAirportsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('&APP_NAME. - US States and Large Airports'));
  });
});
