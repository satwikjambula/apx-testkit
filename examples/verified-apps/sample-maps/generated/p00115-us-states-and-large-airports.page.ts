...
export class UsStatesAndLargeAirportsPage {
  static readonly alias = 'us-states-and-large-airports';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, UsStatesAndLargeAirportsPage.alias);
  }
