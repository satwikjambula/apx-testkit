/**
 * GENERATED by apx-testgen from pages/p00120-airports.apx — DO NOT EDIT.
 ...
 * (./p00120-airports.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, airports-map, facets, search
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), airports-map (map), facets (staticContent).
...
import { AirportsPage } from './p00120-airports.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 120: Airports Faceted Search [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new AirportsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new AirportsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('&APP_NAME. - Airports Faceted Search'));
  });
