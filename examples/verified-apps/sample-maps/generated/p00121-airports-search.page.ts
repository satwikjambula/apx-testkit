...
export class AirportsSearchPage {
  static readonly alias = 'airports-search';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AirportsSearchPage.alias);
  }
  ...
  /** hidden */
  get id(): ApexItem {
    return new ApexItem(this.page, 'P121_ID');
  }
}
