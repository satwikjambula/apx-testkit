/**
 * GENERATED by apx-testgen from pages/p00002-manage-sample-data.apx — DO NOT EDIT.
 ...
 * (./p00002-manage-sample-data.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: buttons, manage-sample-application, manage-sample-data
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): buttons (staticContent), manage-sample-application (staticContent), manage-sample-data (breadcrumb).
...
import { ManageSampleDataPage } from './p00002-manage-sample-data.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 2: Manage Sample Data [requires auth]', () => {
