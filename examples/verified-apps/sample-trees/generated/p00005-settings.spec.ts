/**
 * GENERATED by apx-testgen from pages/p00005-settings.apx — DO NOT EDIT.
 ...
 * (./p00005-settings.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: administration-menu, breadcrumb
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): administration-menu (list), breadcrumb (breadcrumb).
...
import { SettingsPage } from './p00005-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 5: Administration [requires auth]', () => {
