# menu-popup-with-action — verification results
...
`@apx/testgen` produced **5** page object + smoke spec pairs
(4 marked skip: auth required). See `generated/` for
the actual files.
...
**0 added, 0 removed, 0 changed, 5 unchanged** — confirms zero spurious differences.
