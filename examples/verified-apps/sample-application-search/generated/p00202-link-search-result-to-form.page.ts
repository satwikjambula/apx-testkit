...
export class LinkSearchResultToFormPage {
  static readonly alias = 'link-search-result-to-form';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, LinkSearchResultToFormPage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P202_SEARCH');
  }
