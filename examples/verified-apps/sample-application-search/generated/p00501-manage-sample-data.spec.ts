/**
 * GENERATED by apx-testgen from pages/p00501-manage-sample-data.apx — DO NOT EDIT.
 ...
 * (./p00501-manage-sample-data.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, buttons, manage-sample-application
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), buttons (staticContent), manage-sample-application (staticContent).
...
import { ManageSampleDataPage } from './p00501-manage-sample-data.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 501: Manage Sample Data [requires auth]', () => {
  ...
  test('every labeled .apx button exists (2 buttons)', async ({ page }) => {
    const po = new ManageSampleDataPage(page);
    await po.goto();
    await expectButtonsPresent(page, ['Cancel', 'Reset Data']);
  });
});
