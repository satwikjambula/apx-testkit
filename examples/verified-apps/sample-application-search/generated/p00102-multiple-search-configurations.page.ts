...
export class MultipleSearchConfigurationsPage {
  static readonly alias = 'multiple-search-configurations';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, MultipleSearchConfigurationsPage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P102_SEARCH');
  }
