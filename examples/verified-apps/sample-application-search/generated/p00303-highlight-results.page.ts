...
export class HighlightResultsPage {
  static readonly alias = 'highlight-results';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, HighlightResultsPage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P303_SEARCH');
  }
