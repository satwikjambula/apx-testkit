...
export class SearchQueryPrefixPage {
  static readonly alias = 'search-query-prefix';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SearchQueryPrefixPage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P201_SEARCH');
  }
