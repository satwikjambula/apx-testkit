...
export class MultipleSearchRegionsPage {
  static readonly alias = 'multiple-search-regions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, MultipleSearchRegionsPage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P207_SEARCH');
  }
