...
export class FilterSearchConfigurationsPage {
  static readonly alias = 'filter-search-configurations';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, FilterSearchConfigurationsPage.alias);
  }
  ...
  /** checkboxGroup, "Search Within" */
  get checkGrp(): ApexItem {
    return new ApexItem(this.page, 'P206_CHECK_GRP');
  }

  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P206_SEARCH');
  }
