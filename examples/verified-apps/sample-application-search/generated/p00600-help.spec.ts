/**
 * GENERATED by apx-testgen from pages/p00600-help.apx — DO NOT EDIT.
 ...
 * (./p00600-help.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, application-details, features, help-container, quick-start
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (staticContent), application-details (classicReport), features (staticContent), help-container (staticContent), quick-start (staticContent).
...
import { HelpPage } from './p00600-help.page.js';
