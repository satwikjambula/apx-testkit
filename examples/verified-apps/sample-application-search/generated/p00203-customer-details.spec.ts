/**
 * GENERATED by apx-testgen from pages/p00203-customer-details.apx — DO NOT EDIT.
 ...
 * (./p00203-customer-details.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: buttons, customer-details
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): buttons (staticContent), customer-details (form).
...
import { CustomerDetailsPage } from './p00203-customer-details.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 203: Customer Details [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (3 items, 1 hidden)', async ({ page }) => {
    const po = new CustomerDetailsPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P203_CUSTOMER_ID', 'P203_EMAIL_ADDRESS', 'P203_FULL_NAME']);
  });

  test('apex.item round-trip on P203_EMAIL_ADDRESS', async ({ page }) => {
    const po = new CustomerDetailsPage(page);
    await po.goto();
