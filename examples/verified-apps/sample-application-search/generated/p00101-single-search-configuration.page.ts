...
export class SingleSearchConfigurationPage {
  static readonly alias = 'single-search-configuration';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SingleSearchConfigurationPage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P101_SEARCH');
  }
