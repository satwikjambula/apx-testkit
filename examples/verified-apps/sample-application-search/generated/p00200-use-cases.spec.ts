/**
 * GENERATED by apx-testgen from pages/p00200-use-cases.apx — DO NOT EDIT.
 ...
 * (./p00200-use-cases.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, use-cases-navigation
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), use-cases-navigation (list).
...
import { UseCasesPage } from './p00200-use-cases.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 200: Use Cases [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new UseCasesPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new UseCasesPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Use Cases'));
  });
