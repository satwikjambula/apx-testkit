...
export class CustomResultRowTemplatePage {
  static readonly alias = 'custom-result-row-template';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CustomResultRowTemplatePage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P204_SEARCH');
  }
