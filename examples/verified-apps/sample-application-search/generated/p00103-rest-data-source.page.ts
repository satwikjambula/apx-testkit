...
export class RestDataSourcePage {
  static readonly alias = 'rest-data-source';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, RestDataSourcePage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P103_SEARCH');
  }
  ...
  /** "Provide Credentials" */
  async clickProvideCredentials(): Promise<void> {
    await buttonByLabel(this.page, 'Provide Credentials').click();
  }
}
