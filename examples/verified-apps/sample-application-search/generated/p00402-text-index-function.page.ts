...
export class TextIndexFunctionPage {
  static readonly alias = 'text-index-function';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, TextIndexFunctionPage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P402_SEARCH');
  }
