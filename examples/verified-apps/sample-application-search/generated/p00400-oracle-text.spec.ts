/**
 * GENERATED by apx-testgen from pages/p00400-oracle-text.apx — DO NOT EDIT.
 ...
 * (./p00400-oracle-text.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, oracle-text-navigation
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), oracle-text-navigation (list).
...
import { OracleTextPage } from './p00400-oracle-text.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 400: Oracle Text [requires auth]', () => {
