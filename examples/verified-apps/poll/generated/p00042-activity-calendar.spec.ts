/**
 * GENERATED by apx-testgen from pages/p00042-activity-calendar.apx — DO NOT EDIT.
 ...
 * (./p00042-activity-calendar.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: page-view-calendar
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): page-view-calendar (calendar).
...
import { ActivityCalendarPage } from './p00042-activity-calendar.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 42: Activity Calendar [requires auth]', () => {
