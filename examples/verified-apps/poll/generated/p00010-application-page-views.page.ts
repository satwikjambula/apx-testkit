...
export class ApplicationPageViewsPage {
  static readonly alias = 'application-page-views';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ApplicationPageViewsPage.alias);
  }
  ...
  get since(): ApexItem {
    return new ApexItem(this.page, 'P10_SINCE');
  }
