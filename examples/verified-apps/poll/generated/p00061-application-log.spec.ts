/**
 * GENERATED by apx-testgen from pages/p00061-application-log.apx — DO NOT EDIT.
 ...
 * (./p00061-application-log.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: application-log
...
import { ApplicationLogPage } from './p00061-application-log.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 61: Application Log [requires auth]', () => {
