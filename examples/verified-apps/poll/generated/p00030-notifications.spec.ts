/**
 * GENERATED by apx-testgen from pages/p00030-notifications.apx — DO NOT EDIT.
 ...
 * (./p00030-notifications.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: notifications
...
import { NotificationsPage } from './p00030-notifications.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 30: Notifications [requires auth]', () => {
  ...
  test('every labeled .apx button exists (2 buttons)', async ({ page }) => {
    const po = new NotificationsPage(page);
    await po.goto();
    await expectButtonsPresent(page, ['Create Notification', 'Reset']);
  });
