 ...
 * (./p00059-email-history.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: email-history
...
import { EmailHistoryPage } from './p00059-email-history.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 59: Email History [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new EmailHistoryPage(page);
