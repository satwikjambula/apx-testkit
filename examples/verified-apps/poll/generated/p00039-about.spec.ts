/**
 * GENERATED by apx-testgen from pages/p00039-about.apx — DO NOT EDIT.
 ...
 * (./p00039-about.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, application-title, features, getting-started, getting-started-2, getting-started-3, getting-started-4, getting-started-acl, getting-started-email, getting-started-toc, help-container
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (plugin/translatedMessage), application-title (classicReport), features (plugin/translatedMessage), getting-started (plugin/translatedMessage), getting-started-2 (plugin/translatedMessage), getting-started-3 (plugin/translatedMessage), getting-started-4 (plugin/translatedMessage), getting-started-acl (plugin/translatedMessage), getting-started-email (plugin/translatedMessage), getting-started-toc (plugin/translatedMessage), help-container (staticContent).
...
import { AboutPage } from './p00039-about.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 39: About [requires auth]', () => {
