...
export class DefaultEmailAddressesPage {
  static readonly alias = 'default-email-addresses';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, DefaultEmailAddressesPage.alias);
  }
  ...
  /** textField, "From", required */
  get from(): ApexItem {
    return new ApexItem(this.page, 'P58_FROM');
  }

  /** textField, "Reply To" */
  get replyTo(): ApexItem {
    return new ApexItem(this.page, 'P58_REPLY_TO');
  }
