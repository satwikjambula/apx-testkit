...
export class AllRespondentsPage {
  static readonly alias = 'all-respondents';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AllRespondentsPage.alias);
  }
  ...
  /** "Reset" */
  async clickFlowResetButton(): Promise<void> {
