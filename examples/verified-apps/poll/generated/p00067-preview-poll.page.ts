...
export class PreviewPollPage {
  static readonly alias = 'preview-poll';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PreviewPollPage.alias);
  }
  ...
  get pollName(): ApexItem {
    return new ApexItem(this.page, 'P67_POLL_NAME');
  }
