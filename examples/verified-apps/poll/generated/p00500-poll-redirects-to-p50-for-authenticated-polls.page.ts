...
export class PollRedirectsToP50ForAuthenticatedPollsPage {
  static readonly alias = 'poll-redirects-to-p50-for-authenticated-polls';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PollRedirectsToP50ForAuthenticatedPollsPage.alias);
  }
