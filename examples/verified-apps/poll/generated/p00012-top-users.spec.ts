/**
 * GENERATED by apx-testgen from pages/p00012-top-users.apx — DO NOT EDIT.
 ...
 * (./p00012-top-users.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: button-bar, top-users
...
import { TopUsersPage } from './p00012-top-users.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 12: Top Users [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new TopUsersPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P12_SINCE']);
  });
