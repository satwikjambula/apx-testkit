...
export class PollSubmittedPage {
  static readonly alias = 'poll-submitted';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PollSubmittedPage.alias);
  }
  ...
  async clickReturnToHome(): Promise<void> {
    await buttonByLabel(this.page, 'Return to application home').click();
  }

  /** "View Responses" */
  async clickViewResponses(): Promise<void> {
    await buttonByLabel(this.page, 'View Responses').click();
  }
}
