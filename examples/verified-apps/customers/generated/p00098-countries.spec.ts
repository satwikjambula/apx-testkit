/**
 * GENERATED by apx-testgen from pages/p00098-countries.apx — DO NOT EDIT.
 ...
 * (./p00098-countries.page.js), not raw testkit calls, so both stay in sync.
...
import { CountriesPage } from './p00098-countries.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 98: Countries [requires auth]', () => {
