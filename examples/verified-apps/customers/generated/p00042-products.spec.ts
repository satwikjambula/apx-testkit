/**
 * GENERATED by apx-testgen from pages/p00042-products.apx — DO NOT EDIT.
 ...
 * (./p00042-products.page.js), not raw testkit calls, so both stay in sync.
...
import { ProductsPage } from './p00042-products.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 42: Products [requires auth]', () => {
