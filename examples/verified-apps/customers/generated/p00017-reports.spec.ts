/**
 * GENERATED by apx-testgen from pages/p00017-reports.apx — DO NOT EDIT.
 ...
 * (./p00017-reports.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: activity-reports, customer-reports, reports
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): activity-reports (list), customer-reports (list), reports (breadcrumb).
...
import { ReportsPage } from './p00017-reports.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 17: Reports [requires auth]', () => {
