...
export class GeographyPage {
  static readonly alias = 'geography';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, GeographyPage.alias);
  }
  ...
  /** textField, "Geography Name", required */
  get geographyName(): ApexItem {
    return new ApexItem(this.page, 'P49_GEOGRAPHY_NAME');
  }
  ...
  async clickCreate(): Promise<void> {
    await buttonByLabel(this.page, 'Add Geography').click();
  }
