/**
 * GENERATED by apx-testgen from pages/p00076-preferences2.apx — DO NOT EDIT.
 ...
 * (./p00076-preferences2.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: preference, preferences
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): preference (staticContent), preferences (breadcrumb).
...
import { Preferences2Page } from './p00076-preferences2.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 76: Preferences [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new Preferences2Page(page);
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new Preferences2Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P76_TIMEZONE']);
  });
