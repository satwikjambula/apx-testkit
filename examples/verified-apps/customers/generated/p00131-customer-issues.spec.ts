/**
 * GENERATED by apx-testgen from pages/p00131-customer-issues.apx — DO NOT EDIT.
 ...
 * (./p00131-customer-issues.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, customer-issues
...
import { CustomerIssuesPage } from './p00131-customer-issues.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 131: Customer Issues [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new CustomerIssuesPage(page);
