/**
 * GENERATED by apx-testgen from pages/p00031-help.apx — DO NOT EDIT.
 ...
 * (./p00031-help.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, application-title, breadcrumb, features, getting-started, help-container, support
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (plugin/translatedMessage), application-title (classicReport), breadcrumb (breadcrumb), features (plugin/translatedMessage), getting-started (plugin/translatedMessage), help-container (staticContent), support (plugin/translatedMessage).
...
import { HelpPage } from './p00031-help.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 31: Help [requires auth]', () => {
