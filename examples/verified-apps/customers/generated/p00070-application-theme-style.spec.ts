/**
 * GENERATED by apx-testgen from pages/p00070-application-theme-style.apx — DO NOT EDIT.
 ...
 * (./p00070-application-theme-style.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: buttons, items, set-user-interface-theme-style
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): buttons (staticContent), items (staticContent), set-user-interface-theme-style (staticContent).
...
import { ApplicationThemeStylePage } from './p00070-application-theme-style.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 70: Application Theme Style [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new ApplicationThemeStylePage(page);
    await po.goto();
    await expectItemsPresent(page, ['P70_DESKTOP_THEME_STYLE_ID']);
  });
