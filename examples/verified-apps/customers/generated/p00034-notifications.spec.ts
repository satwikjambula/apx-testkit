/**
 * GENERATED by apx-testgen from pages/p00034-notifications.apx — DO NOT EDIT.
 ...
 * (./p00034-notifications.page.js), not raw testkit calls, so both stay in sync.
...
import { NotificationsPage } from './p00034-notifications.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 34: Notifications [requires auth]', () => {
