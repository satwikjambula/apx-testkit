 ...
 * (./p00051-customer-links.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: customer-links, customer-links-2
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): customer-links (breadcrumb).
...
import { CustomerLinksPage } from './p00051-customer-links.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 51: Customer Links [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new CustomerLinksPage(page);
