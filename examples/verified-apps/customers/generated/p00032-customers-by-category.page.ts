...
export class CustomersByCategoryPage {
  static readonly alias = 'customers-by-category';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CustomersByCategoryPage.alias);
  }
  ...
  get category(): ApexItem {
    return new ApexItem(this.page, 'P32_CATEGORY');
  }

  /** selectList, "Geography" */
  get geo(): ApexItem {
    return new ApexItem(this.page, 'P32_GEO');
  }
