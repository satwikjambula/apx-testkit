...
export class CustomerAttachmentsPage {
  static readonly alias = 'customer-attachments';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CustomerAttachmentsPage.alias);
  }
  ...
  get deleteFileId(): ApexItem {
    return new ApexItem(this.page, 'P52_DELETE_FILE_ID');
  }
