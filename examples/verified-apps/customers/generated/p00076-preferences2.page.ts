...
export class Preferences2Page {
  static readonly alias = 'preferences2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, Preferences2Page.alias);
  }
  ...
  get timezone(): ApexItem {
    return new ApexItem(this.page, 'P76_TIMEZONE');
  }
