...
export class ReferenceabilityReport2Page {
  static readonly alias = 'referenceability-report2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReferenceabilityReport2Page.alias);
  }
  ...
  get category(): ApexItem {
    return new ApexItem(this.page, 'P122_CATEGORY');
  }
}
