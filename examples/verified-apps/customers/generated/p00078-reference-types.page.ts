...
export class ReferenceTypesPage {
  static readonly alias = 'reference-types';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReferenceTypesPage.alias);
  }
  ...
  async clickCreate(): Promise<void> {
    await buttonByLabel(this.page, 'Add Reference Type').click();
  }
