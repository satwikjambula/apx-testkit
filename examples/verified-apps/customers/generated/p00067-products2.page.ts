...
export class Products2Page {
  static readonly alias = 'products2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, Products2Page.alias);
  }
  ...
  /** hidden */
  get deleteProdId(): ApexItem {
    return new ApexItem(this.page, 'P67_DELETE_PROD_ID');
  }
