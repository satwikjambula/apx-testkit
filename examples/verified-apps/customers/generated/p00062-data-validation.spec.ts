/**
 * GENERATED by apx-testgen from pages/p00062-data-validation.apx — DO NOT EDIT.
 ...
 * (./p00062-data-validation.page.js), not raw testkit calls, so both stay in sync.
...
import { DataValidationPage } from './p00062-data-validation.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 62: Data Validation [requires auth]', () => {
