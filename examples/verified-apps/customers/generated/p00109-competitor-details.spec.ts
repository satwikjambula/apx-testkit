/**
 * GENERATED by apx-testgen from pages/p00109-competitor-details.apx — DO NOT EDIT.
 ...
 * (./p00109-competitor-details.page.js), not raw testkit calls, so both stay in sync.
...
import { CompetitorDetailsPage } from './p00109-competitor-details.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 109: Competitor Details [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (4 items, 1 hidden)', async ({ page }) => {
    const po = new CompetitorDetailsPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P109_DESCRIPTION', 'P109_ID', 'P109_NAME', 'P109_WEBSITE']);
  });

  test('apex.item round-trip on P109_DESCRIPTION', async ({ page }) => {
    const po = new CompetitorDetailsPage(page);
    await po.goto();
