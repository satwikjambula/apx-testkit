/**
 * GENERATED by apx-testgen from pages/p00025-customer-contacts.apx — DO NOT EDIT.
 ...
 * (./p00025-customer-contacts.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, customer-contacts
...
import { CustomerContactsPage } from './p00025-customer-contacts.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 25: Customer Contacts [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new CustomerContactsPage(page);
