/**
 * GENERATED by apx-testgen from pages/p00057-manage_acl.apx — DO NOT EDIT.
 ...
 * (./p00057-manage_acl.page.js), not raw testkit calls, so both stay in sync.
...
import { ManageAclPage } from './p00057-manage_acl.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 57: Access Control List [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ManageAclPage(page);
