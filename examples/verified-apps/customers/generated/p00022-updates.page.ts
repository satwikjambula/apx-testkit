...
export class UpdatesPage {
  static readonly alias = 'updates';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, UpdatesPage.alias);
  }
  ...
  get calendarDate(): ApexItem {
    return new ApexItem(this.page, 'P22_CALENDAR_DATE');
  }

  /** hidden */
  get calendarType(): ApexItem {
    return new ApexItem(this.page, 'P22_CALENDAR_TYPE');
  }
}
