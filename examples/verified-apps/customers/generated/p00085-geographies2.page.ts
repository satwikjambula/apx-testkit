...
export class Geographies2Page {
  static readonly alias = 'geographies2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, Geographies2Page.alias);
  }
  ...
  get category(): ApexItem {
    return new ApexItem(this.page, 'P85_CATEGORY');
  }
