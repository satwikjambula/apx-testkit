/**
 * GENERATED by apx-testgen from pages/p00011-build-options.apx — DO NOT EDIT.
 ...
 * (./p00011-build-options.page.js), not raw testkit calls, so both stay in sync.
...
import { BuildOptionsPage } from './p00011-build-options.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 11: Build Options [requires auth]', () => {
