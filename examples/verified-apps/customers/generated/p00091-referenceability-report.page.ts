...
export class ReferenceabilityReportPage {
  static readonly alias = 'referenceability-report';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReferenceabilityReportPage.alias);
  }
  ...
  get category(): ApexItem {
    return new ApexItem(this.page, 'P91_CATEGORY');
  }
}
