...
export class Competitors2Page {
  static readonly alias = 'competitors2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, Competitors2Page.alias);
  }
  ...
  /** "Create Competitor" */
  async clickCreateCompetitor(): Promise<void> {
