/**
 * GENERATED by apx-testgen from pages/p00021-activity-calendar.apx — DO NOT EDIT.
 ...
 * (./p00021-activity-calendar.page.js), not raw testkit calls, so both stay in sync.
...
import { ActivityCalendarPage } from './p00021-activity-calendar.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 21: Activity Calendar [requires auth]', () => {
