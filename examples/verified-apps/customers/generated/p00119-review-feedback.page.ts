...
export class ReviewFeedbackPage {
  static readonly alias = 'review-feedback';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReviewFeedbackPage.alias);
  }
  ...
  /** hidden */
  get emailFromAddress(): ApexItem {
    return new ApexItem(this.page, 'P119_EMAIL_FROM_ADDRESS');
  }
