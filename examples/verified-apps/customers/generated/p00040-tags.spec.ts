/**
 * GENERATED by apx-testgen from pages/p00040-tags.apx — DO NOT EDIT.
 ...
 * (./p00040-tags.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, contacts-tag-cloud, customers-tag-cloud, products-tag-cloud
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), contacts-tag-cloud (plugin/tagCloud), customers-tag-cloud (plugin/tagCloud), products-tag-cloud (plugin/tagCloud).
...
import { TagsPage } from './p00040-tags.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 40: Tags [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new TagsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Tags'));
  });
});
