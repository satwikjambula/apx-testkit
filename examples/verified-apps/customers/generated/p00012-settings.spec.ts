/**
 * GENERATED by apx-testgen from pages/p00012-settings.apx — DO NOT EDIT.
 ...
 * (./p00012-settings.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: access-control, access-control-settings, acl-info, acl-status, administration, application-authentication-and-authorization, breadcrumb, code-tables, confirm-enabling-access-control, logging, management, user-counts
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): access-control (list), access-control-settings (staticContent), acl-info (plSqlDynamicContent), acl-status (plugin/aclStatus), administration (list), application-authentication-and-authorization (plugin/authorizationAdministration), breadcrumb (breadcrumb), code-tables (list), confirm-enabling-access-control (staticContent), logging (list), management (list), user-counts (classicReport).
...
import { SettingsPage } from './p00012-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 12: Administration [requires auth]', () => {
