...
export class Referenceability2Page {
  static readonly alias = 'referenceability2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, Referenceability2Page.alias);
  }
  ...
  get category(): ApexItem {
    return new ApexItem(this.page, 'P100_CATEGORY');
  }

  /** selectList, "Geography" */
  get geo(): ApexItem {
    return new ApexItem(this.page, 'P100_GEO');
  }
