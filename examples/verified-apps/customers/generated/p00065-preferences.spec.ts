/**
 * GENERATED by apx-testgen from pages/p00065-preferences.apx — DO NOT EDIT.
 ...
 * (./p00065-preferences.page.js), not raw testkit calls, so both stay in sync.
...
import { PreferencesPage } from './p00065-preferences.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 65: Preferences [requires auth]', () => {
