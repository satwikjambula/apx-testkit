...
export class CustomerIssuesPage {
  static readonly alias = 'customer-issues';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CustomerIssuesPage.alias);
  }
  ...
  get customerId(): ApexItem {
    return new ApexItem(this.page, 'P131_CUSTOMER_ID');
  }

  /** "Add Issue" */
  async clickAddIssue(): Promise<void> {
