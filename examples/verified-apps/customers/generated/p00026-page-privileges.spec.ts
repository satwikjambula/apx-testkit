/**
 * GENERATED by apx-testgen from pages/p00026-page-privileges.apx — DO NOT EDIT.
 ...
 * (./p00026-page-privileges.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: application-page-security
...
import { PagePrivilegesPage } from './p00026-page-privileges.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 26: Page Privileges [requires auth]', () => {
  ...
  test('every interactiveReport/cards/facetedSearch region resolves (1 region)', async ({ page }) => {
    const po = new PagePrivilegesPage(page);
    await po.goto();
    await expectRegionsResolve(page, ['application-page-security']);
  });
});
