...
export class ReferencePhasesPage {
  static readonly alias = 'reference-phases';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReferencePhasesPage.alias);
  }
  ...
  /** "Resequence Display Sequence" */
  async clickResequenceDisplayNumbers(): Promise<void> {
    await buttonByLabel(this.page, 'Resequence Display Sequence').click();
  }
