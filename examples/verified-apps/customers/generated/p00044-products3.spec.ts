/**
 * GENERATED by apx-testgen from pages/p00044-products3.apx — DO NOT EDIT.
 ...
 * (./p00044-products3.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, customer-product-usage
...
import { Products3Page } from './p00044-products3.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 44: Products [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new Products3Page(page);
