 ...
 * (./p00035-page-privileges.page.js), not raw testkit calls, so both stay in sync.
...
import { PagePrivilegesPage } from './p00035-page-privileges.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 35: Page Privileges [requires auth]', () => {
