/**
 * GENERATED by apx-testgen from pages/p00026-settings.apx — DO NOT EDIT.
 ...
 * (./p00026-settings.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: access-control, access-control-settings, acl-info, acl-status, activity-reporting, administration, authentication-and-authorization, breadcrumbs, confirm-enabling-access-control, email, hidden-items, multiple-calendar-users, user-counts
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): access-control (list), access-control-settings (staticContent), acl-info (plSqlDynamicContent), acl-status (plugin/aclStatus), activity-reporting (list), administration (list), authentication-and-authorization (plugin/authorizationAdministration), breadcrumbs (breadcrumb), confirm-enabling-access-control (staticContent), email (list), hidden-items (staticContent), multiple-calendar-users (plSqlDynamicContent), user-counts (classicReport).
...
import { SettingsPage } from './p00026-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 26: Administration [requires auth]', () => {
