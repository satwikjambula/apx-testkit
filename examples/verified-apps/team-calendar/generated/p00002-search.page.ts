...
export class SearchPage {
  static readonly alias = 'search';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SearchPage.alias);
  }
  ...
  async clickDeleteMultiple(): Promise<void> {
    await buttonByLabel(this.page, 'Delete Multiple Events').click();
  }
