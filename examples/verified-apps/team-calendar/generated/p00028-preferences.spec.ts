/**
 * GENERATED by apx-testgen from pages/p00028-preferences.apx — DO NOT EDIT.
 ...
 * (./p00028-preferences.page.js), not raw testkit calls, so both stay in sync.
...
import { PreferencesPage } from './p00028-preferences.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 28: Preferences [requires auth]', () => {
