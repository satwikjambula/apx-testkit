/**
 * GENERATED by apx-testgen from pages/p00016-groups.apx — DO NOT EDIT.
 ...
 * (./p00016-groups.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: groups
...
import { GroupsPage } from './p00016-groups.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 16: Groups [requires auth]', () => {
  ...
  test('every labeled .apx button exists (2 buttons)', async ({ page }) => {
    const po = new GroupsPage(page);
    await po.goto();
    await expectButtonsPresent(page, ['Add Group', 'Reset']);
  });
