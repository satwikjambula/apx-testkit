/**
 * GENERATED by apx-testgen from pages/p00020-group-members2.apx — DO NOT EDIT.
 ...
 * (./p00020-group-members2.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: button-bar, group-members
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): button-bar (staticContent), group-members (classicReport).
...
import { GroupMembers2Page } from './p00020-group-members2.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 20: Group Members [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new GroupMembers2Page(page);
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new GroupMembers2Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P20_GROUP_ID']);
  });
