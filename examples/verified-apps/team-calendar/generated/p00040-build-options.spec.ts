/**
 * GENERATED by apx-testgen from pages/p00040-build-options.apx — DO NOT EDIT.
 ...
 * (./p00040-build-options.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: build-options
...
import { BuildOptionsPage } from './p00040-build-options.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 40: Build Options [requires auth]', () => {
  ...
  test('every interactiveReport/cards/facetedSearch region resolves (1 region)', async ({ page }) => {
    const po = new BuildOptionsPage(page);
    await po.goto();
    await expectRegionsResolve(page, ['build-options']);
  });
});
