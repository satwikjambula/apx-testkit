...
export class GroupMembers2Page {
  static readonly alias = 'group-members2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, GroupMembers2Page.alias);
  }
  ...
  get groupId(): ApexItem {
    return new ApexItem(this.page, 'P20_GROUP_ID');
  }
