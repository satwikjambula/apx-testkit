...
export class UsernameFormatPage {
  static readonly alias = 'username-format';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, UsernameFormatPage.alias);
  }
  ...
  get usernameFormat(): ApexItem {
    return new ApexItem(this.page, 'P38_USERNAME_FORMAT');
  }
