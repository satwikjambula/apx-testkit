/**
 * GENERATED by apx-testgen from pages/p00036-tags.apx — DO NOT EDIT.
 ...
 * (./p00036-tags.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumbs, tags, timezone
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumbs (breadcrumb), tags (plugin/tagCloud), timezone (staticContent).
...
import { TagsPage } from './p00036-tags.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 36: Tags [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new TagsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('&APPLICATION_TITLE. - Tags'));
  });
});
