/**
 * GENERATED by apx-testgen from pages/p00009-activity-calendar.apx — DO NOT EDIT.
 ...
 * (./p00009-activity-calendar.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: activity-calendar
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): activity-calendar (calendar).
...
import { ActivityCalendarPage } from './p00009-activity-calendar.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 9: Activity Calendar [requires auth]', () => {
