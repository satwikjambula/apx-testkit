/**
 * GENERATED by apx-testgen from pages/p00009-orders.apx — DO NOT EDIT.
 ...
 * (./p00009-orders.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: in-progress, orders, past-orders
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): in-progress (themeTemplateComponent/contentRow), orders (regionDisplaySelector), past-orders (themeTemplateComponent/contentRow).
...
import { OrdersPage } from './p00009-orders.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 9: Orders [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new OrdersPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Orders'));
  });
});
