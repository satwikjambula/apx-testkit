...
export class HomePage {
  ...
  async clickSearch(): Promise<void> {
    await buttonByLabel(this.page, 'Search APEXToGo...').click();
  }

  /** "Show All" */
  async clickShowAllDeliveryFree(): Promise<void> {
    await buttonByLabel(this.page, 'Show All').click();
  }

  /** "Show All" */
  async clickShowAllFavorites(): Promise<void> {
    await buttonByLabel(this.page, 'Show All').click();
  }

  /** "Show All" */
  async clickShowAllPopular(): Promise<void> {
    await buttonByLabel(this.page, 'Show All').click();
  }

  /** "Show All" */
  async clickShowAllTodaysOffers(): Promise<void> {
    await buttonByLabel(this.page, 'Show All').click();
  }
}
