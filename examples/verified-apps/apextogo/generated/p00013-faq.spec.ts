/**
 * GENERATED by apx-testgen from pages/p00013-faq.apx — DO NOT EDIT.
 ...
 * (./p00013-faq.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: can-i-see-a-history-of-my-previous-orders, general, how-do-i-place-an-order, how-do-i-report-a-problem-with-my-delivery, is-there-a-minimum-order-amount, what-is-apextogo
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): can-i-see-a-history-of-my-previous-orders (staticContent), general (staticContent), how-do-i-place-an-order (staticContent), how-do-i-report-a-problem-with-my-delivery (staticContent), is-there-a-minimum-order-amount (staticContent), what-is-apextogo (staticContent).
...
import { FaqPage } from './p00013-faq.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 13: FAQ [requires auth]', () => {
