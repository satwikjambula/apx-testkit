/**
 * GENERATED by apx-testgen from pages/p00007-settings.apx — DO NOT EDIT.
 ...
 * (./p00007-settings.page.js), not raw testkit calls, so both stay in sync.
...
import { SettingsPage } from './p00007-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 7: Administration [requires auth]', () => {
