/**
 * GENERATED by apx-testgen from pages/p00002-projects.apx — DO NOT EDIT.
 ...
 * (./p00002-projects.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: application-features-demonstrated-on-this-page, breadcrumb, projects, sql-source
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): application-features-demonstrated-on-this-page (staticContent), breadcrumb (breadcrumb), sql-source (plugin/sourceDisplay).
...
import { ProjectsPage } from './p00002-projects.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 2: Projects [requires auth]', () => {
