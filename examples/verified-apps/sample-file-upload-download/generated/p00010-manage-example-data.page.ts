...
export class ManageExampleDataPage {
  static readonly alias = 'manage-example-data';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ManageExampleDataPage.alias);
  }
  ...
  /** "Recreate" */
  async clickRecreate(): Promise<void> {
    await buttonByLabel(this.page, 'Recreate').click();
  }
}
