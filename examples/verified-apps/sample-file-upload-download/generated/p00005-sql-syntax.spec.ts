/**
 * GENERATED by apx-testgen from pages/p00005-sql-syntax.apx — DO NOT EDIT.
 ...
 * (./p00005-sql-syntax.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, about-this-page-2, breadcrumb, example-sql-queries-used-in-this-application, sql-create-table-syntax-used-in-this-sample-application
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), about-this-page-2 (staticContent), breadcrumb (breadcrumb), example-sql-queries-used-in-this-application (staticContent), sql-create-table-syntax-used-in-this-sample-application (staticContent).
...
import { SqlSyntaxPage } from './p00005-sql-syntax.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 5: SQL Syntax [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new SqlSyntaxPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new SqlSyntaxPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('SQL Syntax'));
  });
});
