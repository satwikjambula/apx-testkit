...
export class DeleteFilesPage {
  static readonly alias = 'delete-files';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, DeleteFilesPage.alias);
  }
  ...
  async clickDelete(): Promise<void> {
    await buttonByLabel(this.page, 'Delete Files').click();
  }
}
