/**
 * GENERATED by apx-testgen from pages/p00039-editing.apx — DO NOT EDIT.
 ...
 * (./p00039-editing.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, breadcrumb, editing-examples
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-application (staticContent), breadcrumb (breadcrumb), editing-examples (list).
...
import { EditingPage } from './p00039-editing.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 39: Editing [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new EditingPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Editing'));
  });
