...
export class TraditionalPagingTotalRowsPage {
  static readonly alias = 'traditional-paging-total-rows';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, TraditionalPagingTotalRowsPage.alias);
  }
