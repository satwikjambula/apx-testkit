/**
 * GENERATED by apx-testgen from pages/p00050-feature-customization.apx — DO NOT EDIT.
 ...
 * (./p00050-feature-customization.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, feature-customization, overview-feature-customization
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), overview-feature-customization (staticContent).
...
import { FeatureCustomizationPage } from './p00050-feature-customization.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 50: Feature Customization [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new FeatureCustomizationPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new FeatureCustomizationPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Feature Customization'));
  });
