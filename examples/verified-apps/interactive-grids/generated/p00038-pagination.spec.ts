/**
 * GENERATED by apx-testgen from pages/p00038-pagination.apx — DO NOT EDIT.
 ...
 * (./p00038-pagination.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, breadcrumb, pagination-examples
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-application (staticContent), breadcrumb (breadcrumb), pagination-examples (list).
...
import { PaginationPage } from './p00038-pagination.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 38: Pagination [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new PaginationPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new PaginationPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Pagination'));
  });
