/**
 * GENERATED by apx-testgen from pages/p00056-item-type-plug-ins.apx — DO NOT EDIT.
 ...
 * (./p00056-item-type-plug-ins.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: basic-editing, breadcrumb, overview-basic-editing
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): basic-editing (interactiveGrid), breadcrumb (breadcrumb), overview-basic-editing (staticContent).
...
import { ItemTypePlugInsPage } from './p00056-item-type-plug-ins.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 56: Item Type Plug-Ins [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ItemTypePlugInsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new ItemTypePlugInsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Item Type Plug-Ins'));
  });
