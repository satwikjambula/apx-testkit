...
export class EditingInADialogPage {
  static readonly alias = 'editing-in-a-dialog';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, EditingInADialogPage.alias);
  }
  ...
  /** hidden */
  get deptno(): ApexItem {
    return new ApexItem(this.page, 'P55_DEPTNO');
  }
