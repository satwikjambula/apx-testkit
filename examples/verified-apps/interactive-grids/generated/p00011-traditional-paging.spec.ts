/**
 * GENERATED by apx-testgen from pages/p00011-traditional-paging.apx — DO NOT EDIT.
 ...
 * (./p00011-traditional-paging.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, overview-traditional-paging, traditional-paging
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), overview-traditional-paging (staticContent), traditional-paging (interactiveGrid).
...
import { TraditionalPagingPage } from './p00011-traditional-paging.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 11: Traditional Paging [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new TraditionalPagingPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new TraditionalPagingPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Traditional Paging'));
  });
