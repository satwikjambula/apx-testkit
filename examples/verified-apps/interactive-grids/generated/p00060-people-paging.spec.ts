/**
 * GENERATED by apx-testgen from pages/p00060-people-paging.apx — DO NOT EDIT.
 ...
 * (./p00060-people-paging.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, overview-people-paging, people-paging
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), overview-people-paging (staticContent), people-paging (interactiveGrid).
...
import { PeoplePagingPage } from './p00060-people-paging.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 60: People (paging) [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new PeoplePagingPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new PeoplePagingPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('People (paging)'));
  });
