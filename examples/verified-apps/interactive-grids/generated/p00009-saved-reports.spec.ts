/**
 * GENERATED by apx-testgen from pages/p00009-saved-reports.apx — DO NOT EDIT.
 ...
 * (./p00009-saved-reports.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, overview-saved-reports, saved-reports
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), overview-saved-reports (staticContent), saved-reports (interactiveGrid).
...
import { SavedReportsPage } from './p00009-saved-reports.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 9: Saved Reports [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new SavedReportsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new SavedReportsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Saved Reports'));
  });
