/**
 * GENERATED by apx-testgen from pages/p00052-tooltips.apx — DO NOT EDIT.
 ...
 * (./p00052-tooltips.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, overview-tooltips, tooltips
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), overview-tooltips (staticContent), tooltips (interactiveGrid).
...
import { TooltipsPage } from './p00052-tooltips.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 52: Tooltips [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new TooltipsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new TooltipsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Tooltips'));
  });
