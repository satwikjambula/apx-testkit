/**
 * GENERATED by apx-testgen from pages/p00036-other-column-types.apx — DO NOT EDIT.
 ...
 * (./p00036-other-column-types.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, other-column-types, overview-other-column-types
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), other-column-types (interactiveGrid), overview-other-column-types (staticContent).
...
import { OtherColumnTypesPage } from './p00036-other-column-types.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 36: Other Column Types [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new OtherColumnTypesPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new OtherColumnTypesPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Other Column Types'));
  });
