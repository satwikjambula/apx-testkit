/**
 * GENERATED by apx-testgen from pages/p00013-icon-and-detail-views.apx — DO NOT EDIT.
 ...
 * (./p00013-icon-and-detail-views.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, icon-and-detail-views, overview-icon-and-detail-views
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), overview-icon-and-detail-views (staticContent).
...
import { IconAndDetailViewsPage } from './p00013-icon-and-detail-views.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 13: Icon and Detail Views [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new IconAndDetailViewsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new IconAndDetailViewsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Icon and Detail Views'));
  });
