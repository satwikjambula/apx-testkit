/**
 * GENERATED by apx-testgen from pages/p00058-dynamic-actions.apx — DO NOT EDIT.
 ...
 * (./p00058-dynamic-actions.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, dynamic-actions, overview-dynamic-actions
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), dynamic-actions (interactiveGrid), overview-dynamic-actions (staticContent).
...
import { DynamicActionsPage } from './p00058-dynamic-actions.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 58: Dynamic Actions [requires auth]', () => {
