...
export class TraditionalPagingSelectListPage {
  static readonly alias = 'traditional-paging-select-list';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, TraditionalPagingSelectListPage.alias);
  }
