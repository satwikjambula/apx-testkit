/**
 * GENERATED by apx-testgen from pages/p00026-application-theme-style.apx — DO NOT EDIT.
 ...
 * (./p00026-application-theme-style.page.js), not raw testkit calls, so both stay in sync.
...
import { ApplicationThemeStylePage } from './p00026-application-theme-style.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 26: Application Theme Style [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new ApplicationThemeStylePage(page);
    await po.goto();
    await expectItemsPresent(page, ['P26_DESKTOP_THEME_STYLE_ID']);
  });
