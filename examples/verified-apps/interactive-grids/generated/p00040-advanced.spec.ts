/**
 * GENERATED by apx-testgen from pages/p00040-advanced.apx — DO NOT EDIT.
 ...
 * (./p00040-advanced.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, advanced-examples, breadcrumb
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-application (staticContent), advanced-examples (list), breadcrumb (breadcrumb).
...
import { AdvancedPage } from './p00040-advanced.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 40: Advanced [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new AdvancedPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new AdvancedPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Advanced'));
  });
