/**
 * GENERATED by apx-testgen from pages/p00024-data-load-results.apx — DO NOT EDIT.
 ...
 * (./p00024-data-load-results.page.js), not raw testkit calls, so both stay in sync.
...
import { DataLoadResultsPage } from './p00024-data-load-results.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 24: Data Load Results [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (4 items, 0 hidden)', async ({ page }) => {
    const po = new DataLoadResultsPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P24_ERROR_COUNT', 'P24_INSERT_COUNT', 'P24_REVIEW_COUNT', 'P24_UPDATE_COUNT']);
  });
