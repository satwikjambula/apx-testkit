/**
 * GENERATED by apx-testgen from pages/p00001-sample-data-loading.apx — DO NOT EDIT.
 ...
 * (./p00001-sample-data-loading.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, app-name, data-load-examples, footer
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (staticContent), app-name (staticContent), data-load-examples (list), footer (plugin/sampleAppsFooter).
...
import { SampleDataLoadingPage } from './p00001-sample-data-loading.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 1: Sample Data Loading [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new SampleDataLoadingPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new SampleDataLoadingPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Sample Data Loading'));
  });
});
