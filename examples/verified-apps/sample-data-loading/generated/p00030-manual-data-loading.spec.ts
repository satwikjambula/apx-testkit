/**
 * GENERATED by apx-testgen from pages/p00030-manual-data-loading.apx — DO NOT EDIT.
 ...
 * (./p00030-manual-data-loading.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, manual-data-loading
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), manual-data-loading (list).
...
import { ManualDataLoadingPage } from './p00030-manual-data-loading.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 30: Manual Data Loading [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ManualDataLoadingPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new ManualDataLoadingPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Manual Data Loading'));
  });
});
