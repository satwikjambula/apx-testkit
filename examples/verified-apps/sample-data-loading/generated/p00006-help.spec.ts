/**
 * GENERATED by apx-testgen from pages/p00006-help.apx — DO NOT EDIT.
 ...
 * (./p00006-help.page.js), not raw testkit calls, so both stay in sync.
...
import { HelpPage } from './p00006-help.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 6: Help [requires auth]', () => {
