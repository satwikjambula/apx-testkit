/**
 * GENERATED by apx-testgen from pages/p00036-settings.apx — DO NOT EDIT.
 ...
 * (./p00036-settings.page.js), not raw testkit calls, so both stay in sync.
...
import { SettingsPage } from './p00036-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 36: Administration [requires auth]', () => {
