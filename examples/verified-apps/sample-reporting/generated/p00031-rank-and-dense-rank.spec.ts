/**
 * GENERATED by apx-testgen from pages/p00031-rank-and-dense-rank.apx — DO NOT EDIT.
 ...
 * (./p00031-rank-and-dense-rank.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, container, rank-and-dense-rank, sql-source
...
import { RankAndDenseRankPage } from './p00031-rank-and-dense-rank.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 31: RANK and DENSE_RANK [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new RankAndDenseRankPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new RankAndDenseRankPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('RANK and DENSE_RANK'));
  });
