/**
 * GENERATED by apx-testgen from pages/p00026-connect-by.apx — DO NOT EDIT.
 ...
 * (./p00026-connect-by.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, connect-by, sql-source
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), breadcrumb (breadcrumb), connect-by (classicReport), sql-source (plugin/sourceDisplay).
...
import { ConnectByPage } from './p00026-connect-by.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 26: Connect By [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ConnectByPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new ConnectByPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Connect By'));
  });
});
