/**
 * GENERATED by apx-testgen from pages/p00004-manage-sample-data.apx — DO NOT EDIT.
 ...
 * (./p00004-manage-sample-data.page.js), not raw testkit calls, so both stay in sync.
...
import { ManageSampleDataPage } from './p00004-manage-sample-data.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 4: Manage Sample Data [requires auth]', () => {
