/**
 * GENERATED by apx-testgen from pages/p00001-interactive-report.apx — DO NOT EDIT.
 ...
 * (./p00001-interactive-report.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumbs, projects, sql-source
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), breadcrumbs (breadcrumb), sql-source (plugin/sourceDisplay).
...
import { InteractiveReportPage } from './p00001-interactive-report.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 1: Interactive Report [requires auth]', () => {
