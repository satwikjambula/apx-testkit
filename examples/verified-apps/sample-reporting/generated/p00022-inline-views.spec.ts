/**
 * GENERATED by apx-testgen from pages/p00022-inline-views.apx — DO NOT EDIT.
 ...
 * (./p00022-inline-views.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, container, inline-views, sql-source
...
import { InlineViewsPage } from './p00022-inline-views.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 22: Inline Views [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new InlineViewsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new InlineViewsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Inline Views'));
  });
