/**
 * GENERATED by apx-testgen from pages/p00010-home.apx — DO NOT EDIT.
 ...
 * (./p00010-home.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-sample-application, app-name, breadcrumb, oracle-apex-communities-and-resources, report-examples
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-sample-application (staticContent), app-name (staticContent), breadcrumb (breadcrumb), oracle-apex-communities-and-resources (plugin/sampleAppsFooter), report-examples (list).
...
import { HomePage } from './p00010-home.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 10: Home [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new HomePage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Sample Reporting'));
  });
});
