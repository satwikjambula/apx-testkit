/**
 * GENERATED by apx-testgen from pages/p00017-interactive-grid.apx — DO NOT EDIT.
 ...
 * (./p00017-interactive-grid.page.js), not raw testkit calls, so both stay in sync.
...
import { InteractiveGridPage } from './p00017-interactive-grid.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 17: Interactive Grid [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new InteractiveGridPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Interactive Grid'));
  });
