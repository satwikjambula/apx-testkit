...
export class BindVariablesPage {
  static readonly alias = 'bind-variables';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, BindVariablesPage.alias);
  }
  ...
  get project(): ApexItem {
    return new ApexItem(this.page, 'P15_PROJECT');
  }
