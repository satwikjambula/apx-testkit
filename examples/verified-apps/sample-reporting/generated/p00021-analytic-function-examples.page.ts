...
export class AnalyticFunctionExamplesPage {
  static readonly alias = 'analytic-function-examples';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AnalyticFunctionExamplesPage.alias);
  }
