...
export class ReportFromCollectionPage {
  static readonly alias = 'report-from-collection';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReportFromCollectionPage.alias);
  }
  ...
  /** "Recreate Collection" */
  async clickRecreateCollection(): Promise<void> {
    await buttonByLabel(this.page, 'Recreate Collection').click();
  }
