...
export class RegularExpressionsPage {
  static readonly alias = 'regular-expressions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, RegularExpressionsPage.alias);
  }
  ...
  get function(): ApexItem {
    return new ApexItem(this.page, 'P28_FUNCTION');
  }
