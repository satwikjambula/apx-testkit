/**
 * GENERATED by apx-testgen from pages/p00037-linking-to-interactive-grids.apx — DO NOT EDIT.
 ...
 * (./p00037-linking-to-interactive-grids.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, container, developer-supplied-query, interactive-grid, report-linking-examples
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), breadcrumb (breadcrumb), container (staticContent), developer-supplied-query (plugin/sourceDisplay), report-linking-examples (list).
...
import { LinkingToInteractiveGridsPage } from './p00037-linking-to-interactive-grids.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 37: Linking to Interactive Grids [requires auth]', () => {
