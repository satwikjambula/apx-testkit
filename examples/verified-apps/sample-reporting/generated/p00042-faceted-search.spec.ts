/**
 * GENERATED by apx-testgen from pages/p00042-faceted-search.apx — DO NOT EDIT.
 ...
 * (./p00042-faceted-search.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumbs, button-bar, search, search-results
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), breadcrumbs (breadcrumb), button-bar (staticContent), search-results (classicReport).
...
import { FacetedSearchPage } from './p00042-faceted-search.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 42: Faceted Search [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new FacetedSearchPage(page);
