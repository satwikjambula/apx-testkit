...
export class PivotSyntaxPage {
  static readonly alias = 'pivot-syntax';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PivotSyntaxPage.alias);
  }
  ...
  /** hidden */
  get operator(): ApexItem {
    return new ApexItem(this.page, 'P25_OPERATOR');
  }
}
