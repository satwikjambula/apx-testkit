...
export class LinkingToInteractiveGridsPage {
  static readonly alias = 'linking-to-interactive-grids';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, LinkingToInteractiveGridsPage.alias);
  }
