/**
 * GENERATED by apx-testgen from pages/p00007-highlighting.apx — DO NOT EDIT.
 ...
 * (./p00007-highlighting.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, container, highlighting, projects, sql-source
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), container (staticContent), highlighting (breadcrumb), sql-source (plugin/sourceDisplay).
...
import { HighlightingPage } from './p00007-highlighting.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 7: Highlighting [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new HighlightingPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new HighlightingPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Highlighting'));
  });
