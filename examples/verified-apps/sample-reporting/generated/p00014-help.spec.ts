/**
 * GENERATED by apx-testgen from pages/p00014-help.apx — DO NOT EDIT.
 ...
 * (./p00014-help.page.js), not raw testkit calls, so both stay in sync.
...
import { HelpPage } from './p00014-help.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 14: Help [requires auth]', () => {
