/**
 * GENERATED by apx-testgen from pages/p00021-analytic-function-examples.apx — DO NOT EDIT.
 ...
 * (./p00021-analytic-function-examples.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: analytic-functions, breadcrumb
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): analytic-functions (list), breadcrumb (breadcrumb).
...
import { AnalyticFunctionExamplesPage } from './p00021-analytic-function-examples.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 21: Analytic Function Examples [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new AnalyticFunctionExamplesPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new AnalyticFunctionExamplesPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Analytic Function Examples'));
  });
});
