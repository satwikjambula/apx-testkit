/**
 * GENERATED by apx-testgen from pages/p00009-use-cases.apx — DO NOT EDIT.
 ...
 * (./p00009-use-cases.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, report-use-cases
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), report-use-cases (list).
...
import { UseCasesPage } from './p00009-use-cases.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 9: Use Cases [requires auth]', () => {
