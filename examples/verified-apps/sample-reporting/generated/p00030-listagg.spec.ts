/**
 * GENERATED by apx-testgen from pages/p00030-listagg.apx — DO NOT EDIT.
 ...
 * (./p00030-listagg.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, container, listagg-query-syntax, sql-source
...
import { ListaggPage } from './p00030-listagg.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 30: LISTAGG [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new ListaggPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('LISTAGG'));
  });
