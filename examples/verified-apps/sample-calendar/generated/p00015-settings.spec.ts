/**
 * GENERATED by apx-testgen from pages/p00015-settings.apx — DO NOT EDIT.
 ...
 * (./p00015-settings.page.js), not raw testkit calls, so both stay in sync.
...
import { SettingsPage } from './p00015-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 15: Administration [requires auth]', () => {
