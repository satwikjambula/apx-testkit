/**
 * GENERATED by apx-testgen from pages/p00007-report.apx — DO NOT EDIT.
 ...
 * (./p00007-report.page.js), not raw testkit calls, so both stay in sync.
...
import { ReportPage } from './p00007-report.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 7: Report [requires auth]', () => {
