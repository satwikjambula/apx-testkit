/**
 * GENERATED by apx-testgen from pages/p00091-week-calendar-conference2.apx — DO NOT EDIT.
 ...
 * (./p00091-week-calendar-conference2.page.js), not raw testkit calls, so both stay in sync.
...
import { WeekCalendarConference2Page } from './p00091-week-calendar-conference2.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 91: Week Calendar: Conference [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new WeekCalendarConference2Page(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new WeekCalendarConference2Page(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Week Calendar: Conference'));
  });
});
