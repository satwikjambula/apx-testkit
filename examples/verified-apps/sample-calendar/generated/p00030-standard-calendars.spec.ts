/**
 * GENERATED by apx-testgen from pages/p00030-standard-calendars.apx — DO NOT EDIT.
 ...
 * (./p00030-standard-calendars.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breakcrumb, standard-calendars
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breakcrumb (breadcrumb), standard-calendars (list).
...
import { StandardCalendarsPage } from './p00030-standard-calendars.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 30: Standard Calendars [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new StandardCalendarsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new StandardCalendarsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Standard Calendars'));
  });
});
