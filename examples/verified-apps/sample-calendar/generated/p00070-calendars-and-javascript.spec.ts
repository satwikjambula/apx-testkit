/**
 * GENERATED by apx-testgen from pages/p00070-calendars-and-javascript.apx — DO NOT EDIT.
 ...
 * (./p00070-calendars-and-javascript.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, calendars-and-javascript
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), calendars-and-javascript (list).
...
import { CalendarsAndJavascriptPage } from './p00070-calendars-and-javascript.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 70: Calendars and Javascript [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new CalendarsAndJavascriptPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new CalendarsAndJavascriptPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Calendars and Javascript'));
  });
});
