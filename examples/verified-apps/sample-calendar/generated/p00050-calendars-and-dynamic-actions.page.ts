...
export class CalendarsAndDynamicActionsPage {
  static readonly alias = 'calendars-and-dynamic-actions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CalendarsAndDynamicActionsPage.alias);
  }
