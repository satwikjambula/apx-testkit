/**
 * GENERATED by apx-testgen from pages/p00032-week-calendar-conference.apx — DO NOT EDIT.
 ...
 * (./p00032-week-calendar-conference.page.js), not raw testkit calls, so both stay in sync.
...
import { WeekCalendarConferencePage } from './p00032-week-calendar-conference.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 32: Week Calendar: Conference [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new WeekCalendarConferencePage(page);
