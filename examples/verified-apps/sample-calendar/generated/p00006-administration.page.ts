...
export class AdministrationPage {
  static readonly alias = 'administration';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AdministrationPage.alias);
  }
  ...
  /** "View Report" */
  async clickViewReport(): Promise<void> {
    await buttonByLabel(this.page, 'View Report').click();
  }
}
