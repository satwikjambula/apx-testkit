...
export class DeleteEventsByClickPage {
  static readonly alias = 'delete-events-by-click';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, DeleteEventsByClickPage.alias);
  }
  ...
  get sessionId(): ApexItem {
    return new ApexItem(this.page, 'P53_SESSION_ID');
  }

  /** switch, "Show Inactive Sessions" */
  get showInactive(): ApexItem {
    return new ApexItem(this.page, 'P53_SHOW_INACTIVE');
  }
}
