...
export class CustomDragDropHandlersPage {
  static readonly alias = 'custom-drag-drop-handlers';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CustomDragDropHandlersPage.alias);
  }
  ...
  /** hidden */
  get dragdropMsg(): ApexItem {
    return new ApexItem(this.page, 'P112_DRAGDROP_MSG');
  }
}
