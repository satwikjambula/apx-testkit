/**
 * GENERATED by apx-testgen from pages/p00050-calendars-and-dynamic-actions.apx — DO NOT EDIT.
 ...
 * (./p00050-calendars-and-dynamic-actions.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, calendars-and-dynamic-actions
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), calendars-and-dynamic-actions (list).
...
import { CalendarsAndDynamicActionsPage } from './p00050-calendars-and-dynamic-actions.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 50: Calendars and Dynamic Actions [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new CalendarsAndDynamicActionsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new CalendarsAndDynamicActionsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Calendars and Dynamic Actions'));
  });
});
