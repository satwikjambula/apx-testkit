...
export class WeeklyCalendarEditSessionsPage {
  static readonly alias = 'weekly-calendar-edit-sessions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, WeeklyCalendarEditSessionsPage.alias);
  }
  ...
  get showInactive(): ApexItem {
    return new ApexItem(this.page, 'P33_SHOW_INACTIVE');
  }
}
