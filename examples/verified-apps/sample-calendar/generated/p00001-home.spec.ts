 ...
 * Regions present in metadata: about-this-application, app-name, calendar-examples, footer
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (staticContent), app-name (staticContent), calendar-examples (list), footer (plugin/sampleAppsFooter).
...
test.describe('page 1: Sample Calendar [requires auth]', () => {
