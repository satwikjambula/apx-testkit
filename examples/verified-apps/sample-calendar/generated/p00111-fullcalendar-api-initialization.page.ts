...
export class FullcalendarApiInitializationPage {
  static readonly alias = 'fullcalendar-api-initialization';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, FullcalendarApiInitializationPage.alias);
  }
