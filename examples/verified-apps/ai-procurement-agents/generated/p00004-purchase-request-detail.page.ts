...
export class PurchaseRequestDetailPage {
  static readonly alias = 'purchase-request-detail';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PurchaseRequestDetailPage.alias);
  }
  ...
  /** hidden */
  get purchaseRequestId(): ApexItem {
    return new ApexItem(this.page, 'P4_PURCHASE_REQUEST_ID');
  }
}
