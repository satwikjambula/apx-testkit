...
export class EditPurchaseRequestPage {
  static readonly alias = 'edit-purchase-request';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, EditPurchaseRequestPage.alias);
  }
  ...
  get purchaseRequestId(): ApexItem {
    return new ApexItem(this.page, 'P3_PURCHASE_REQUEST_ID');
  }
}
