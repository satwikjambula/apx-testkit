/**
 * GENERATED by apx-testgen from pages/p10051-job-reporting.apx — DO NOT EDIT.
 ...
 * (./p10051-job-reporting.page.js), not raw testkit calls, so both stay in sync.
...
import { JobReportingPage } from './p10051-job-reporting.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 10051: Job Reporting [requires auth]', () => {
