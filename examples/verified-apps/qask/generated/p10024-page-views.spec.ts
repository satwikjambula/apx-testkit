/**
 * GENERATED by apx-testgen from pages/p10024-page-views.apx — DO NOT EDIT.
 ...
 * (./p10024-page-views.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, buttons, page-views
...
import { PageViewsPage } from './p10024-page-views.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 10024: Page Views [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new PageViewsPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P10024_TIMEFRAME']);
  });
