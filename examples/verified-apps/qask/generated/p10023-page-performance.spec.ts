/**
 * GENERATED by apx-testgen from pages/p10023-page-performance.apx — DO NOT EDIT.
 ...
 * (./p10023-page-performance.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, buttons, page-performance
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), buttons (staticContent).
...
import { PagePerformancePage } from './p10023-page-performance.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 10023: Page Performance [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new PagePerformancePage(page);
    await po.goto();
    await expectItemsPresent(page, ['P10023_TIMEFRAME']);
  });
