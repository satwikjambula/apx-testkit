...
- `staticContent`: 59
- `breadcrumb`: 21
- `interactiveReport`: 15
- `classicReport`: 12
- `form`: 8
- `chart`: 6
- `dynamicContent`: 5
- `list`: 4
- `themeTemplateComponent/contentRow`: 2
...
`@apx/testgen` produced **41** page object + smoke spec pairs
(32 marked skip: auth required). See `generated/` for
the actual files.
...
**0 added, 0 removed, 0 changed, 41 unchanged** — confirms zero spurious differences.
