/**
 * GENERATED by apx-testgen from pages/p00140-my-requests.apx — DO NOT EDIT.
 ...
 * (./p00140-my-requests.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, my-requests
...
import { MyRequestsPage } from './p00140-my-requests.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 140: My Requests [requires auth]', () => {
