...
export class JobHistoryViewPage {
  static readonly alias = 'job-history-view';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, JobHistoryViewPage.alias);
  }
  ...
  get jobCode(): ApexItem {
    return new ApexItem(this.page, 'P101_JOB_CODE');
  }
}
