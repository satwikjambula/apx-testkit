 ...
 * (./p00050-job-access-matrix.page.js), not raw testkit calls, so both stay in sync.
...
import { JobAccessMatrixPage } from './p00050-job-access-matrix.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 50: Job Access Matrix [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new JobAccessMatrixPage(page);
