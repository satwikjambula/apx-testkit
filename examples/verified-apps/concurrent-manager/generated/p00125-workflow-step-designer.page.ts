...
export class WorkflowStepDesignerPage {
  static readonly alias = 'workflow-step-designer';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, WorkflowStepDesignerPage.alias);
  }
  ...
  get setCode(): ApexItem {
    return new ApexItem(this.page, 'P125_SET_CODE');
  }
}
