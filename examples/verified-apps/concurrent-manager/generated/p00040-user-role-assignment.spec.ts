/**
 * GENERATED by apx-testgen from pages/p00040-user-role-assignment.apx — DO NOT EDIT.
 ...
 * (./p00040-user-role-assignment.page.js), not raw testkit calls, so both stay in sync.
...
import { UserRoleAssignmentPage } from './p00040-user-role-assignment.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 40: User Role Assignment [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new UserRoleAssignmentPage(page);
