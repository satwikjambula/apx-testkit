 ...
 * Regions present in metadata: api-catalog-status, app-name, runtime-status, vector-model-status
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): api-catalog-status (staticContent), app-name (staticContent), runtime-status (staticContent), vector-model-status (staticContent).
