/**
 * GENERATED by apx-testgen from pages/p00020-sales-by-store-by-day.apx — DO NOT EDIT.
...
import { SalesByStoreByDayPage } from './p00020-sales-by-store-by-day.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 20: Sales by Store by Day [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new SalesByStoreByDayPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new SalesByStoreByDayPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Sales by Store by Day'));
  });
