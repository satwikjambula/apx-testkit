...
export class SalesHistoryClassicIrPage {
  static readonly alias = 'sales-history-classic-ir';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SalesHistoryClassicIrPage.alias);
  }
  ...
  get navigation(): ApexItem {
    return new ApexItem(this.page, 'P51_NAVIGATION');
  }
