...
export class TransactionSummaryByHourPage {
  static readonly alias = 'transaction-summary-by-hour';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, TransactionSummaryByHourPage.alias);
  }
