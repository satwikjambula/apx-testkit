...
export class SalesHistoryContentRowPage {
  static readonly alias = 'sales-history-content-row';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SalesHistoryContentRowPage.alias);
  }
  ...
  get navigation(): ApexItem {
    return new ApexItem(this.page, 'P2_NAVIGATION');
  }
