...
export class TransactionSummaryByMinutePage {
  static readonly alias = 'transaction-summary-by-minute';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, TransactionSummaryByMinutePage.alias);
  }
