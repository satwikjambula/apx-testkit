...
export class SalesByProductPage {
  static readonly alias = 'sales-by-product';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SalesByProductPage.alias);
  }
  ...
  /** hidden */
  get procuctName(): ApexItem {
    return new ApexItem(this.page, 'P18_PROCUCT_NAME');
  }
