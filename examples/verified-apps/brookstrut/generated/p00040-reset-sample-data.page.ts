...
export class ResetSampleDataPage {
  static readonly alias = 'reset-sample-data';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ResetSampleDataPage.alias);
  }
  ...
  /** hidden */
  get size(): ApexItem {
    return new ApexItem(this.page, 'P40_SIZE');
  }
