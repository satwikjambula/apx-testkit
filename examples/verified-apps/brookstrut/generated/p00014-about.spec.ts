/**
 * GENERATED by apx-testgen from pages/p00014-about.apx — DO NOT EDIT.
 ...
 * (./p00014-about.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, app-name, breadcrumb, features, help-container
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (staticContent), app-name (classicReport), breadcrumb (breadcrumb), features (staticContent), help-container (staticContent).
...
import { AboutPage } from './p00014-about.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 14: About [requires auth]', () => {
