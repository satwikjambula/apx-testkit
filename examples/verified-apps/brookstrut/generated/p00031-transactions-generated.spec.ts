/**
 * GENERATED by apx-testgen from pages/p00031-transactions-generated.apx — DO NOT EDIT.
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), generate-100-transactions-on-page-load (staticContent), show-last-generation (plSqlDynamicContent), timing (dynamicContent).
...
import { TransactionsGeneratedPage } from './p00031-transactions-generated.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 31: 100 Transactions Generated [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new TransactionsGeneratedPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new TransactionsGeneratedPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('100 Transactions Generated'));
  });

  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 1 hidden)', async ({ page }) => {
    const po = new TransactionsGeneratedPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P31_TRANSACTION_ID']);
  });

  test('every labeled .apx button exists (2 buttons)', async ({ page }) => {
    const po = new TransactionsGeneratedPage(page);
    await po.goto();
    await expectButtonsPresent(page, ['Generate 100 Transactions', 'Up']);
  });
});
