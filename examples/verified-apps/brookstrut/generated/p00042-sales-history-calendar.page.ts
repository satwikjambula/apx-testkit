...
export class SalesHistoryCalendarPage {
  static readonly alias = 'sales-history-calendar';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SalesHistoryCalendarPage.alias);
  }
  ...
  get navigation(): ApexItem {
    return new ApexItem(this.page, 'P42_NAVIGATION');
  }
