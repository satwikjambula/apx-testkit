...
export class SalesHistoryContentRowWithMenuPage {
  static readonly alias = 'sales-history-content-row-with-menu';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SalesHistoryContentRowWithMenuPage.alias);
  }
  ...
  get navigation(): ApexItem {
    return new ApexItem(this.page, 'P38_NAVIGATION');
  }
