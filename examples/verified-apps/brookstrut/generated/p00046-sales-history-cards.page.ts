...
export class SalesHistoryCardsPage {
  static readonly alias = 'sales-history-cards';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SalesHistoryCardsPage.alias);
  }
  ...
  get navigation(): ApexItem {
    return new ApexItem(this.page, 'P46_NAVIGATION');
  }
