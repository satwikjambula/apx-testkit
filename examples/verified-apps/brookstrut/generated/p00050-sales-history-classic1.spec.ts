/**
 * GENERATED by apx-testgen from pages/p00050-sales-history-classic1.apx — DO NOT EDIT.
 ...
 * (./p00050-sales-history-classic1.page.js), not raw testkit calls, so both stay in sync.
...
import { SalesHistoryClassic1Page } from './p00050-sales-history-classic1.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 50: Sales History Classic [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new SalesHistoryClassic1Page(page);
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new SalesHistoryClassic1Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P50_NAVIGATION']);
  });
