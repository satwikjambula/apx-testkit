/**
 * GENERATED by apx-testgen from pages/p00051-sales-history-classic-ir.apx — DO NOT EDIT.
 ...
 * (./p00051-sales-history-classic-ir.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, facets, sales-history, timer
 ...
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), facets (staticContent), timer (dynamicContent).
...
import { SalesHistoryClassicIrPage } from './p00051-sales-history-classic-ir.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 51: Sales History Interactive Report [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new SalesHistoryClassicIrPage(page);
