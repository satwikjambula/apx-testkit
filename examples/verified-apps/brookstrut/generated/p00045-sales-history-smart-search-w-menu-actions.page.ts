...
export class SalesHistorySmartSearchWMenuActionsPage {
  static readonly alias = 'sales-history-smart-search-w-menu-actions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SalesHistorySmartSearchWMenuActionsPage.alias);
  }
  ...
  get navigation(): ApexItem {
    return new ApexItem(this.page, 'P45_NAVIGATION');
  }
