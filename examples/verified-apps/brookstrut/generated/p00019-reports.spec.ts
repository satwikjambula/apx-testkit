/**
 * GENERATED by apx-testgen from pages/p00019-reports.apx — DO NOT EDIT.
 ...
 * (./p00019-reports.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, summary-reports, transaction-reports
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), summary-reports (list), transaction-reports (list).
...
import { ReportsPage } from './p00019-reports.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 19: Reports [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new ReportsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Reports'));
  });
