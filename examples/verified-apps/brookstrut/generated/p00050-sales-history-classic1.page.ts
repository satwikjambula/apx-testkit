...
export class SalesHistoryClassic1Page {
  static readonly alias = 'sales-history-classic1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SalesHistoryClassic1Page.alias);
  }
  ...
  get navigation(): ApexItem {
    return new ApexItem(this.page, 'P50_NAVIGATION');
  }
