...
export class GenerateTransactionPage {
  static readonly alias = 'generate-transaction';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, GenerateTransactionPage.alias);
  }
  ...
  get transactionId(): ApexItem {
    return new ApexItem(this.page, 'P29_TRANSACTION_ID');
  }

  /** "Generate Transaction" */
  async clickGenerateTransaction(): Promise<void> {
    await buttonByLabel(this.page, 'Generate Transaction').click();
  }
