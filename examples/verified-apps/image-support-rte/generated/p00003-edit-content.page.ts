...
export class EditContentPage {
  static readonly alias = 'edit-content';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, EditContentPage.alias);
  }
  ...
  get body(): ApexItem {
    return new ApexItem(this.page, 'P3_BODY');
  }
  ...
  get newImageRefId(): ApexItem {
    return new ApexItem(this.page, 'P3_NEW_IMAGE_REF_ID');
  }
