/**
 * GENERATED by apx-testgen from pages/p00307-map1.apx — DO NOT EDIT.
 ...
 * (./p00307-map1.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, overview, stores-data, stores-map
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), overview (staticContent), stores-map (map).
...
import { Map1Page } from './p00307-map1.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 307: Map [requires auth]', () => {
  ...
  test('every interactiveReport/cards/facetedSearch region resolves (1 region)', async ({ page }) => {
    const po = new Map1Page(page);
    await po.goto();
    await expectRegionsResolve(page, ['stores-data']);
  });
});
