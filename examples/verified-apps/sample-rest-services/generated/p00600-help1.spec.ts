/**
 * GENERATED by apx-testgen from pages/p00600-help1.apx — DO NOT EDIT.
 ...
 * (./p00600-help1.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, application-information, features, help-container, quick-start
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (staticContent), application-information (classicReport), features (staticContent), help-container (staticContent), quick-start (staticContent).
...
import { Help1Page } from './p00600-help1.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 600: Help [requires auth]', () => {
