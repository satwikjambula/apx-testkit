...
export class InvokeApiProcess1Page {
  static readonly alias = 'invoke-api-process1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, InvokeApiProcess1Page.alias);
  }
  ...
  get message(): ApexItem {
    return new ApexItem(this.page, 'P402_MESSAGE');
  }

  /** hidden */
  get status(): ApexItem {
    return new ApexItem(this.page, 'P402_STATUS');
  }
  ...
  /** "Raise Salary" */
  async clickRaiseSalary(): Promise<void> {
    await buttonByLabel(this.page, 'Raise Salary').click();
  }
}
