/**
 * GENERATED by apx-testgen from pages/p00500-administration1.apx — DO NOT EDIT.
 ...
 * (./p00500-administration1.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: administration-settings, breadcrumb, column
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): administration-settings (list), breadcrumb (breadcrumb), column (staticContent).
...
import { Administration1Page } from './p00500-administration1.page.js';
...
test.describe('page 500: Administration [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new Administration1Page(page);
