/**
 * GENERATED by apx-testgen from pages/p00300-data-display-options.apx — DO NOT EDIT.
 ...
 * (./p00300-data-display-options.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, data-display-options-list
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), data-display-options-list (list).
...
import { DataDisplayOptionsPage } from './p00300-data-display-options.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 300: Data Display Options [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new DataDisplayOptionsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new DataDisplayOptionsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Data Display Options'));
  });
