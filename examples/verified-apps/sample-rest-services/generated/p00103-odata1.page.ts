...
export class Odata1Page {
  static readonly alias = 'odata1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, Odata1Page.alias);
  }
  ...
  /** "Set OData URL" */
  async clickSetOdataUrl(): Promise<void> {
    await buttonByLabel(this.page, 'Set OData URL').click();
  }
}
