...
export class NestedJsonDynamicActionsPage {
  static readonly alias = 'nested-json-dynamic-actions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, NestedJsonDynamicActionsPage.alias);
  }
  ...
  /** hidden */
  get poPNumber(): ApexItem {
    return new ApexItem(this.page, 'PO_P_NUMBER');
  }
