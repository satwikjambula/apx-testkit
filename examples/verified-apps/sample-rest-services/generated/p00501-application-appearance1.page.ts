...
export class ApplicationAppearance1Page {
  static readonly alias = 'application-appearance1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ApplicationAppearance1Page.alias);
  }
  ...
  get desktopThemeStyleId(): ApexItem {
    return new ApexItem(this.page, 'P501_DESKTOP_THEME_STYLE_ID');
  }
