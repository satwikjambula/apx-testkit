/**
 * GENERATED by apx-testgen from pages/p00308-calendar1.apx — DO NOT EDIT.
 ...
 * (./p00308-calendar1.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, overview, projects-calendar
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), overview (staticContent), projects-calendar (calendar).
...
import { Calendar1Page } from './p00308-calendar1.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 308: Calendar [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new Calendar1Page(page);
