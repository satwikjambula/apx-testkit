/**
 * GENERATED by apx-testgen from pages/p00100-rest-integrations1.apx — DO NOT EDIT.
 ...
 * (./p00100-rest-integrations1.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, rest-integration-list
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), rest-integration-list (list).
...
import { RestIntegrations1Page } from './p00100-rest-integrations1.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 100: "REST Integrations " [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new RestIntegrations1Page(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new RestIntegrations1Page(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('REST Integrations'));
  });
