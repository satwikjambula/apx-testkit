...
export class CardsLayout1Page {
  static readonly alias = 'cards-layout1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CardsLayout1Page.alias);
  }
  ...
  /** "Set Credentials" */
  async clickSetCredentials(): Promise<void> {
    await buttonByLabel(this.page, 'Set Credentials').click();
  }
}
