...
export class CombineWithRelationalDataPage {
  static readonly alias = 'combine-with-relational-data';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CombineWithRelationalDataPage.alias);
  }
