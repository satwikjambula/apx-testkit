/**
 * GENERATED by apx-testgen from pages/p00503-web-credentials-settings1.apx — DO NOT EDIT.
 ...
 * (./p00503-web-credentials-settings1.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, overview, web-credential
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), overview (staticContent), web-credential (staticContent).
...
import { WebCredentialsSettings1Page } from './p00503-web-credentials-settings1.page.js';
...
test.describe('page 503: Web Credentials Settings [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new WebCredentialsSettings1Page(page);
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (3 items, 1 hidden)', async ({ page }) => {
    const po = new WebCredentialsSettings1Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P304_SOURCE', 'P3_API_KEY', 'P3_NAME']);
  });
