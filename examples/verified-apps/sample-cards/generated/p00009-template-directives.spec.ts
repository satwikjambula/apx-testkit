/**
 * GENERATED by apx-testgen from pages/p00009-template-directives.apx — DO NOT EDIT.
 ...
 * (./p00009-template-directives.page.js), not raw testkit calls, so both stay in sync.
...
import { TemplateDirectivesPage } from './p00009-template-directives.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 9: Template Directives [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new TemplateDirectivesPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('&APP_NAME. - Template Directives'));
  });
