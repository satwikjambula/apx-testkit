 ...
 * (./p00005-blob-column-as-url.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, media-image
...
import { BlobColumnAsUrlPage } from './p00005-blob-column-as-url.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 5: BLOB Column as URL [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new BlobColumnAsUrlPage(page);
