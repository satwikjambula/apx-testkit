/**
 * GENERATED by apx-testgen from pages/p00020-basics.apx — DO NOT EDIT.
 ...
 * (./p00020-basics.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: basic-card-options, breadcrumb
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): basic-card-options (list), breadcrumb (breadcrumb).
...
import { BasicsPage } from './p00020-basics.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 20: Basics [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new BasicsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('&APP_NAME. - Basics'));
  });
});
