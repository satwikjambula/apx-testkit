/**
 * GENERATED by apx-testgen from pages/p00019-advanced.apx — DO NOT EDIT.
 ...
 * (./p00019-advanced.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: advanced-charting-options, breadcrumb
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): advanced-charting-options (list), breadcrumb (breadcrumb).
...
import { AdvancedPage } from './p00019-advanced.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 19: Advanced [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new AdvancedPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('&APP_NAME. - Advanced'));
  });
});
