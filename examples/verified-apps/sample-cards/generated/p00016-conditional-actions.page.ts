...
export class ConditionalActionsPage {
  static readonly alias = 'conditional-actions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ConditionalActionsPage.alias);
  }
  ...
  get orderBy(): ApexItem {
    return new ApexItem(this.page, 'P16_ORDER_BY');
  }
}
