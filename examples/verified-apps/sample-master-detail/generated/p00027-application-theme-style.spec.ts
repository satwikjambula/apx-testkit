/**
 * GENERATED by apx-testgen from pages/p00027-application-theme-style.apx — DO NOT EDIT.
 ...
 * (./p00027-application-theme-style.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, items
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-page (staticContent), breadcrumb (breadcrumb), items (staticContent).
...
import { ApplicationThemeStylePage } from './p00027-application-theme-style.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 27: Application Theme Style [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (2 items, 0 hidden)', async ({ page }) => {
    const po = new ApplicationThemeStylePage(page);
    await po.goto();
    await expectItemsPresent(page, ['P27_DESKTOP_THEME_STYLE_ID', 'P27_MOBILE_THEME_STYLE_ID']);
  });
