 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), comments (classicReport), master-project (classicReport), milestones (classicReport), project-actions (list), region-display-selector (regionDisplaySelector), tasks (classicReport).
