/**
 * GENERATED by apx-testgen from pages/p00006-milestones.apx — DO NOT EDIT.
 ...
 * (./p00006-milestones.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: eba-demo-md-milestones
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): eba-demo-md-milestones (interactiveGrid).
...
import { MilestonesPage } from './p00006-milestones.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 6: Milestones [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new MilestonesPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new MilestonesPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Milestones'));
  });
});
