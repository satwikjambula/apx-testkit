 ...
 * Regions present in metadata: about-this-application, app-name, master-detail-pages, oracle-apex-communities-and-resources
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (staticContent), app-name (staticContent), master-detail-pages (list), oracle-apex-communities-and-resources (plugin/sampleAppsFooter).
