/**
 * GENERATED by apx-testgen from pages/p00012-comments.apx — DO NOT EDIT.
 ...
 * (./p00012-comments.page.js), not raw testkit calls, so both stay in sync.
 ...
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): comments (interactiveGrid).
...
import { CommentsPage } from './p00012-comments.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 12: Comments [requires auth]', () => {
