 ...
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), links (classicReport), master-task (classicReport), region-display-selector (regionDisplaySelector), task-actions (list), to-dos (classicReport).
