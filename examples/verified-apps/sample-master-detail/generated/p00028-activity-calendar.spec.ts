/**
 * GENERATED by apx-testgen from pages/p00028-activity-calendar.apx — DO NOT EDIT.
 ...
 * (./p00028-activity-calendar.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: activity-calendar, breadcrumb
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): activity-calendar (calendar), breadcrumb (breadcrumb).
...
import { ActivityCalendarPage } from './p00028-activity-calendar.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 28: Activity Calendar [requires auth]', () => {
