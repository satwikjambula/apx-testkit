/**
 * GENERATED by apx-testgen from pages/p00102-feedback.apx — DO NOT EDIT.
 ...
 * (./p00102-feedback.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: feedback, wizard-buttons
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): feedback (staticContent), wizard-buttons (staticContent).
...
import { FeedbackPage } from './p00102-feedback.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 102: Feedback [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (4 items, 0 hidden)', async ({ page }) => {
    const po = new FeedbackPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P102_APPLICATION_ID', 'P102_FEEDBACK', 'P102_FEEDBACK_TYPE', 'P102_PAGE_ID']);
  });

  test('apex.item round-trip on P102_FEEDBACK', async ({ page }) => {
    const po = new FeedbackPage(page);
    await po.goto();
