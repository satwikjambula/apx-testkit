/**
 * GENERATED by apx-testgen from pages/p00008-tasks.apx — DO NOT EDIT.
 ...
 * (./p00008-tasks.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: eba-demo-md-tasks
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): eba-demo-md-tasks (interactiveGrid).
...
import { TasksPage } from './p00008-tasks.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 8: Tasks [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new TasksPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Tasks'));
  });
});
