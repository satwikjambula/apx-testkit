/**
 * GENERATED by apx-testgen from pages/p00013-help.apx — DO NOT EDIT.
 ...
 * (./p00013-help.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, app-name, application-details, approving-requests, help-topics, initiating-appraisals, need-help, requesting-changes, user-accounts-for-approvals
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-application (staticContent), app-name (staticContent), application-details (classicReport), approving-requests (staticContent), help-topics (regionDisplaySelector), initiating-appraisals (staticContent), need-help (staticContent), requesting-changes (staticContent), user-accounts-for-approvals (staticContent).
...
import { HelpPage } from './p00013-help.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 13: Help [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new HelpPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Help'));
  });
});
