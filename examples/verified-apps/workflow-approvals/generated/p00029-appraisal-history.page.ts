...
export class AppraisalHistoryPage {
  static readonly alias = 'appraisal-history';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AppraisalHistoryPage.alias);
  }
  ...
  /** switch, "Show for Subordinates?" */
  get showForSubordinates(): ApexItem {
    return new ApexItem(this.page, 'P29_SHOW_FOR_SUBORDINATES');
  }
}
