...
export class ApproversPage {
  static readonly alias = 'approvers';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ApproversPage.alias);
  }
  ...
  /** "Test Salary Approver Assignment..." */
  async clickTestAssignment(): Promise<void> {
    await buttonByLabel(this.page, 'Test Salary Approver Assignment...').click();
  }
}
