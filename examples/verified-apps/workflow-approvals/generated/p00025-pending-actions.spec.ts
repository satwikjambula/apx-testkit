/**
 * GENERATED by apx-testgen from pages/p00025-pending-actions.apx — DO NOT EDIT.
 ...
 * (./p00025-pending-actions.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, pending-actions
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-page (staticContent), breadcrumb (breadcrumb), pending-actions (classicReport).
...
import { PendingActionsPage } from './p00025-pending-actions.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 25: Pending Actions [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new PendingActionsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new PendingActionsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Pending Appraisals'));
  });
});
