/**
 * GENERATED by apx-testgen from pages/p00031-workflow-diagram.apx — DO NOT EDIT.
 ...
 * (./p00031-workflow-diagram.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: workflow-diagram
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): workflow-diagram (workflowDiagram).
...
import { WorkflowDiagramPage } from './p00031-workflow-diagram.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 31: Workflow Diagram [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new WorkflowDiagramPage(page);
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (3 items, 2 hidden)', async ({ page }) => {
    const po = new WorkflowDiagramPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P31_CURRENT_WORKFLOW', 'P31_WORKFLOW_ID', 'P31_WORKFLOW_TITLE']);
  });
});
