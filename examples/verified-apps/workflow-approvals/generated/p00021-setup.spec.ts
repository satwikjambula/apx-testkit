/**
 * GENERATED by apx-testgen from pages/p00021-setup.apx — DO NOT EDIT.
 ...
 * (./p00021-setup.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: setup, setup-2
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): setup (breadcrumb), setup-2 (list).
...
import { SetupPage } from './p00021-setup.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 21: Setup [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new SetupPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Setup'));
  });
});
