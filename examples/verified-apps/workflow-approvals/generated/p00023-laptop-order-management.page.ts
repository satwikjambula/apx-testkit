...
export class LaptopOrderManagementPage {
  static readonly alias = 'laptop-order-management';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, LaptopOrderManagementPage.alias);
  }
  ...
  /** switch, "All" */
  get showDelivered(): ApexItem {
    return new ApexItem(this.page, 'P23_SHOW_DELIVERED');
  }
}
