/**
 * GENERATED by apx-testgen from pages/p00018-manage-sample-data.apx — DO NOT EDIT.
 ...
 * (./p00018-manage-sample-data.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, manage-sample-data
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-page (staticContent), manage-sample-data (breadcrumb).
...
import { ManageSampleDataPage } from './p00018-manage-sample-data.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 18: Manage Sample Data [requires auth]', () => {
  ...
  test('every labeled .apx button exists (1 button)', async ({ page }) => {
    const po = new ManageSampleDataPage(page);
    await po.goto();
    await expectButtonsPresent(page, ['Reset Sample Data']);
  });
});
