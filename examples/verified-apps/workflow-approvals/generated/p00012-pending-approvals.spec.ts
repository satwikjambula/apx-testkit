/**
 * GENERATED by apx-testgen from pages/p00012-pending-approvals.apx — DO NOT EDIT.
 ...
 * (./p00012-pending-approvals.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, handle-deadlines-and-refresh, pending-approvals
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-page (staticContent), breadcrumb (breadcrumb), handle-deadlines-and-refresh (staticContent), pending-approvals (classicReport).
...
import { PendingApprovalsPage } from './p00012-pending-approvals.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 12: Pending Approvals [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new PendingApprovalsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new PendingApprovalsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Pending Approvals'));
  });
});
