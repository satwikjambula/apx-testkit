/**
 * GENERATED by apx-testgen from pages/p00032-manage-laptop-stock.apx — DO NOT EDIT.
 ...
 * (./p00032-manage-laptop-stock.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, manage-laptop-stock
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-page (staticContent), breadcrumb (breadcrumb), manage-laptop-stock (interactiveGrid).
...
import { ManageLaptopStockPage } from './p00032-manage-laptop-stock.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 32: Manage Laptop Stock [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ManageLaptopStockPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new ManageLaptopStockPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Manage Laptop Stock'));
  });
});
