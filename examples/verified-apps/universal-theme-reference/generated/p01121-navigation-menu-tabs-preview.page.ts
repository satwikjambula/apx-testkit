...
export class NavigationMenuTabsPreviewPage {
  static readonly alias = 'navigation-menu-tabs-preview';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, NavigationMenuTabsPreviewPage.alias);
  }
