...
export class SideColumnsPageWithSideNavigationPage {
  static readonly alias = 'side-columns-page-with-side-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SideColumnsPageWithSideNavigationPage.alias);
  }
