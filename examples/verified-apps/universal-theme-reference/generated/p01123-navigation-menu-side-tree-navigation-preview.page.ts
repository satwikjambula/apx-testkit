...
export class NavigationMenuSideTreeNavigationPreviewPage {
  static readonly alias = 'navigation-menu-side-tree-navigation-preview';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, NavigationMenuSideTreeNavigationPreviewPage.alias);
  }
