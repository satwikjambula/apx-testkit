...
export class StandardPageTemplateWithSideNavigationPage {
  static readonly alias = 'standard-page-template-with-side-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, StandardPageTemplateWithSideNavigationPage.alias);
  }
