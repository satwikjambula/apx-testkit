...
export class MarqueeDetailPageWithTopNavigationPage {
  static readonly alias = 'marquee-detail-page-with-top-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, MarqueeDetailPageWithTopNavigationPage.alias);
  }
