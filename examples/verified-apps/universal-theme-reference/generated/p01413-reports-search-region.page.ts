...
export class ReportsSearchRegionPage {
  static readonly alias = 'reports-search-region';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReportsSearchRegionPage.alias);
  }
  ...
  /** textField, "Search" */
  get searchField(): ApexItem {
    return new ApexItem(this.page, 'P1413_SEARCH_FIELD');
  }
}
