...
export class LeftColumnPageWithSideNavigationPage {
  static readonly alias = 'left-column-page-with-side-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, LeftColumnPageWithSideNavigationPage.alias);
  }
