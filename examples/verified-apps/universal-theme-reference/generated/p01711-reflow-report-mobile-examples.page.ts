...
export class ReflowReportMobileExamplesPage {
  static readonly alias = 'reflow-report-mobile-examples';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReflowReportMobileExamplesPage.alias);
  }
