...
export class LeftColumnPageWithTopNavigationPage {
  static readonly alias = 'left-column-page-with-top-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, LeftColumnPageWithTopNavigationPage.alias);
  }
