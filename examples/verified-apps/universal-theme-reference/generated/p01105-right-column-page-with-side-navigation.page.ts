...
export class RightColumnPageWithSideNavigationPage {
  static readonly alias = 'right-column-page-with-side-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, RightColumnPageWithSideNavigationPage.alias);
  }
