...
export class ModalDialogDemoFitWindowPage {
  static readonly alias = 'modal-dialog-demo-fit-window';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ModalDialogDemoFitWindowPage.alias);
  }
