...
export class RegionListViewMobileExamplePage {
  static readonly alias = 'region-list-view-mobile-example';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, RegionListViewMobileExamplePage.alias);
  }
