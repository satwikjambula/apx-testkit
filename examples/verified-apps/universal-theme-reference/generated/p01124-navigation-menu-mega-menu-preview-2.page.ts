...
export class NavigationMenuMegaMenuPreview2Page {
  static readonly alias = 'navigation-menu-mega-menu-preview-2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, NavigationMenuMegaMenuPreview2Page.alias);
  }
