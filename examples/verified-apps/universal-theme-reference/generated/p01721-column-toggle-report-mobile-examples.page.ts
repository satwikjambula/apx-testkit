...
export class ColumnToggleReportMobileExamplesPage {
  static readonly alias = 'column-toggle-report-mobile-examples';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ColumnToggleReportMobileExamplesPage.alias);
  }
