...
export class FlexboxContainerComponentPage {
  static readonly alias = 'flexbox-container-component';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, FlexboxContainerComponentPage.alias);
  }
