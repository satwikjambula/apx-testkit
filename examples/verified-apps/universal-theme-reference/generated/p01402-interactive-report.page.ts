...
export class InteractiveReportPage {
  static readonly alias = 'interactive-report';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, InteractiveReportPage.alias);
  }
  ...
  /** "Right of Search Bar" */
  async clickRightOfIrBar(): Promise<void> {
    await buttonByLabel(this.page, 'Right of Search Bar').click();
  }
}
