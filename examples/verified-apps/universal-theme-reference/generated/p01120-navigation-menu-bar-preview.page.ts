...
export class NavigationMenuBarPreviewPage {
  static readonly alias = 'navigation-menu-bar-preview';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, NavigationMenuBarPreviewPage.alias);
  }
