...
export class StandardPageTemplateWithTopNavigationPage {
  static readonly alias = 'standard-page-template-with-top-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, StandardPageTemplateWithTopNavigationPage.alias);
  }
