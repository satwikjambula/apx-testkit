...
export class StandardPageTemplateWithTabsNavigationPage {
  static readonly alias = 'standard-page-template-with-tabs-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, StandardPageTemplateWithTabsNavigationPage.alias);
  }
