...
export class MediaListComponentPage {
  static readonly alias = 'media-list-component';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, MediaListComponentPage.alias);
  }
  ...
  get orderBy(): ApexItem {
    return new ApexItem(this.page, 'P3005_ORDER_BY');
  }
}
