...
export class RightColumnPageWithTopNavigationPage {
  static readonly alias = 'right-column-page-with-top-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, RightColumnPageWithTopNavigationPage.alias);
  }
