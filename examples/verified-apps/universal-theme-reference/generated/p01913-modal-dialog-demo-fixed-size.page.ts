...
export class ModalDialogDemoFixedSizePage {
  static readonly alias = 'modal-dialog-demo-fixed-size';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ModalDialogDemoFixedSizePage.alias);
  }
