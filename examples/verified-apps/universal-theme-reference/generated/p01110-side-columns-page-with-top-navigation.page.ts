...
export class SideColumnsPageWithTopNavigationPage {
  static readonly alias = 'side-columns-page-with-top-navigation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SideColumnsPageWithTopNavigationPage.alias);
  }
