 ...
 * (./p00003-edit.page.js), not raw testkit calls, so both stay in sync.
...
import { EditPage } from './p00003-edit.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 3: Edit [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (9 items, 1 hidden)', async ({ page }) => {
    const po = new EditPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P3_COMM', 'P3_DEPTNO', 'P3_EMPNO', 'P3_ENAME', 'P3_HIREDATE', 'P3_JOB', 'P3_MGR', 'P3_ROWID', 'P3_SAL']);
  });
