 ...
 * Regions present in metadata: about, app-name, breadcrumbs, dynamic-action-demonstrations, footer
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about (staticContent), app-name (staticContent), breadcrumbs (breadcrumb), dynamic-action-demonstrations (list), footer (plugin/sampleAppsFooter).
