/**
 * GENERATED by apx-testgen from pages/p00009-edit4.apx — DO NOT EDIT.
 ...
 * (./p00009-edit4.page.js), not raw testkit calls, so both stay in sync.
...
import { Edit4Page } from './p00009-edit4.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 9: Edit [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (9 items, 1 hidden)', async ({ page }) => {
    const po = new Edit4Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P9_COMM', 'P9_DEPTNO', 'P9_EMPNO', 'P9_ENAME', 'P9_HIREDATE', 'P9_JOB', 'P9_MGR', 'P9_ROWID', 'P9_SAL']);
  });

  test('apex.item round-trip on P9_EMPNO', async ({ page }) => {
    const po = new Edit4Page(page);
    await po.goto();
