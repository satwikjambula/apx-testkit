...
export class ExecutePlSqlCodePage {
  static readonly alias = 'execute-pl-sql-code';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ExecutePlSqlCodePage.alias);
  }
  ...
  /** "Update Salary by 10%" */
  async clickUpdateSalary(): Promise<void> {
    await buttonByLabel(this.page, 'Update Salary by 10%').click();
  }
}
