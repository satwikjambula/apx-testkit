/**
 * GENERATED by apx-testgen from pages/p00008-add-remove-class-focus.apx — DO NOT EDIT.
 ...
 * (./p00008-add-remove-class-focus.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, employees, overview
 ...
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): breadcrumb (breadcrumb), overview (staticContent).
...
import { AddRemoveClassFocusPage } from './p00008-add-remove-class-focus.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 8: Add/Remove Class (Focus) [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new AddRemoveClassFocusPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new AddRemoveClassFocusPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Add/Remove Class (Focus)'));
  });
