 ...
 * (./p00013-edit5.page.js), not raw testkit calls, so both stay in sync.
...
import { Edit5Page } from './p00013-edit5.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 13: Edit [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (11 items, 1 hidden)', async ({ page }) => {
    const po = new Edit5Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P13_COMM', 'P13_DEPTNO', 'P13_EMPNO', 'P13_ENAME', 'P13_HIREDATE', 'P13_JOB', 'P13_LOCATION', 'P13_MGR', 'P13_NO_OF_EMPLOYEES', 'P13_ROWID', 'P13_SAL']);
  });

  test('apex.item round-trip on P13_EMPNO', async ({ page }) => {
    const po = new Edit5Page(page);
    await po.goto();
