/**
 * GENERATED by apx-testgen from pages/p00023-settings.apx — DO NOT EDIT.
 ...
 * (./p00023-settings.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: administration, buttons, reset-application-data
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): administration (breadcrumb), buttons (staticContent), reset-application-data (staticContent).
...
import { SettingsPage } from './p00023-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 23: Administration [requires auth]', () => {
