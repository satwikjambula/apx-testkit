...
export class FilterAndRefreshPage {
  static readonly alias = 'filter-and-refresh';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, FilterAndRefreshPage.alias);
  }
  ...
  get deptno(): ApexItem {
    return new ApexItem(this.page, 'P19_DEPTNO');
  }

  /** selectList, "Job" */
  get job(): ApexItem {
    return new ApexItem(this.page, 'P19_JOB');
  }

  /** "Reset" */
  async clickP19Reset(): Promise<void> {
