...
export class VectorVsOracleText1Page {
  static readonly alias = 'vector-vs-oracle-text1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, VectorVsOracleText1Page.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P16_SEARCH');
  }
}
