...
export class MovieRecommendationPage {
  static readonly alias = 'movie-recommendation';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, MovieRecommendationPage.alias);
  }
  ...
  /** selectOne, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P41_SEARCH');
  }
}
