/**
 * GENERATED by apx-testgen from pages/p00013-prepare-movie-data-3.apx — DO NOT EDIT.
 ...
 * (./p00013-prepare-movie-data-3.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: buttons, data-loading-summary, data-uploaded-successfully, progress
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): buttons (staticContent), data-loading-summary (classicReport), data-uploaded-successfully (staticContent), progress (list).
...
import { PrepareMovieData3Page } from './p00013-prepare-movie-data-3.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 13: Prepare Movie Data (Step 3: Preview) [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new PrepareMovieData3Page(page);
