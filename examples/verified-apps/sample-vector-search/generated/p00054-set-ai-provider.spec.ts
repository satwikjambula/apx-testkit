 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), button-oci (staticContent), button-openai (staticContent), enter-oci-web-credentials (staticContent), enter-openai-web-credentials (staticContent), select-provider (staticContent), web-credentials (staticContent).
