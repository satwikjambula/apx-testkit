/**
 * GENERATED by apx-testgen from pages/p00030-prepare-custom-data-4.apx — DO NOT EDIT.
 ...
 * (./p00030-prepare-custom-data-4.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: custom-vector-search-navigation, progress, ready-for-vector-search
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): custom-vector-search-navigation (list), progress (list), ready-for-vector-search (staticContent).
...
import { PrepareCustomData4Page } from './p00030-prepare-custom-data-4.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 30: Prepare Custom Data (Step 4: Overview) [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new PrepareCustomData4Page(page);
