...
export class PrepareCustomData3Page {
  static readonly alias = 'prepare-custom-data-3';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PrepareCustomData3Page.alias);
  }
  ...
  async clickGenerateVectorEmbeddings(): Promise<void> {
    await buttonByLabel(this.page, 'Generate Vector Embeddings').click();
  }
