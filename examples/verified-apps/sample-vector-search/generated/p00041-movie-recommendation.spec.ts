 ...
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-movie-recommendation (staticContent), breadcrumb (breadcrumb), content (staticContent), search (staticContent), search-results-oci (search), search-results-openai (search).
