...
export class VectorVsOracleTextPage {
  static readonly alias = 'vector-vs-oracle-text';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, VectorVsOracleTextPage.alias);
  }
  ...
  /** textField, "Search" */
  get search(): ApexItem {
    return new ApexItem(this.page, 'P32_SEARCH');
  }
}
