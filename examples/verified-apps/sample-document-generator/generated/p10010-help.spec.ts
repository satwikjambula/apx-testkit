/**
 * GENERATED by apx-testgen from pages/p10010-help.apx — DO NOT EDIT.
 ...
 * (./p10010-help.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-application, application-details, features, getting-started, help-container
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (staticContent), application-details (classicReport), features (staticContent), getting-started (staticContent), help-container (staticContent).
...
import { HelpPage } from './p10010-help.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 10010: About [requires auth]', () => {
