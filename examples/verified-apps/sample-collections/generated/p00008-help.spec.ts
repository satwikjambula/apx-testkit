/**
 * GENERATED by apx-testgen from pages/p00008-help.apx — DO NOT EDIT.
 ...
 * (./p00008-help.page.js), not raw testkit calls, so both stay in sync.
...
import { HelpPage } from './p00008-help.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 8: Help [requires auth]', () => {
