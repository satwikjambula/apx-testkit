...
export class SampleCollectionsApiExamplesPage {
  static readonly alias = 'sample-collections-api-examples';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SampleCollectionsApiExamplesPage.alias);
  }
