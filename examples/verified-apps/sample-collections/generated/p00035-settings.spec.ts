/**
 * GENERATED by apx-testgen from pages/p00035-settings.apx — DO NOT EDIT.
 ...
 * (./p00035-settings.page.js), not raw testkit calls, so both stay in sync.
...
import { SettingsPage } from './p00035-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 35: Administration [requires auth]', () => {
