 ...
 * Regions present in metadata: about-this-application, app-name, breadcrumb, collection-examples, footer
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about-this-application (staticContent), app-name (staticContent), breadcrumb (breadcrumb), collection-examples (list), footer (plugin/sampleAppsFooter).
...
test.describe('page 100: Home [requires auth]', () => {
