...
export class RevenueByQuarterPage {
  static readonly alias = 'revenue-by-quarter';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, RevenueByQuarterPage.alias);
  }
  ...
  /** selectList, "Beginning" */
  get beginQtr(): ApexItem {
    return new ApexItem(this.page, 'P14_BEGIN_QTR');
  }

  /** selectList, "Ending" */
  get endQtr(): ApexItem {
    return new ApexItem(this.page, 'P14_END_QTR');
  }
}
