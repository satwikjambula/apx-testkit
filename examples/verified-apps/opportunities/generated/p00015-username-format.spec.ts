/**
 * GENERATED by apx-testgen from pages/p00015-username-format.apx — DO NOT EDIT.
 ...
 * (./p00015-username-format.page.js), not raw testkit calls, so both stay in sync.
...
import { UsernameFormatPage } from './p00015-username-format.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 15: Username Format [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new UsernameFormatPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P15_USERNAME_FORMAT']);
  });
