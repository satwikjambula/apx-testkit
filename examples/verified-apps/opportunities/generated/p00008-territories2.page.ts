...
export class Territories2Page {
  static readonly alias = 'territories2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, Territories2Page.alias);
  }
  ...
  /** "Create Territory" */
  async clickCreateTerritory(): Promise<void> {
