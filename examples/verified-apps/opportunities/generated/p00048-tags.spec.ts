/**
 * GENERATED by apx-testgen from pages/p00048-tags.apx — DO NOT EDIT.
 ...
 * (./p00048-tags.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: account-tags, breadcrumb, contact-tags, lead-tags, opportunity-tags, product-tags, territory-tags
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): account-tags (plugin/tagCloud), breadcrumb (breadcrumb), contact-tags (plugin/tagCloud), lead-tags (plugin/tagCloud), opportunity-tags (plugin/tagCloud), product-tags (plugin/tagCloud), territory-tags (plugin/tagCloud).
...
import { TagsPage } from './p00048-tags.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 48: Tags [requires auth]', () => {
