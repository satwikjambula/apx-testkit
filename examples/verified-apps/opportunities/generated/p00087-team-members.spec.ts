 ...
 * (./p00087-team-members.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, team-members
...
import { TeamMembersPage } from './p00087-team-members.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 87: Team Members [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new TeamMembersPage(page);
