...
export class AgreementTypesPage {
  static readonly alias = 'agreement-types';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AgreementTypesPage.alias);
  }
  ...
  /** "Add Agreement Type" */
  async clickAddAgreementType(): Promise<void> {
