...
export class SupportAmountTypesPage {
  static readonly alias = 'support-amount-types';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SupportAmountTypesPage.alias);
  }
  ...
  async clickAddSupportAmtType(): Promise<void> {
