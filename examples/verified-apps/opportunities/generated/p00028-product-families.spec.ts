/**
 * GENERATED by apx-testgen from pages/p00028-product-families.apx — DO NOT EDIT.
 ...
 * (./p00028-product-families.page.js), not raw testkit calls, so both stay in sync.
...
import { ProductFamiliesPage } from './p00028-product-families.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 28: Product Families [requires auth]', () => {
