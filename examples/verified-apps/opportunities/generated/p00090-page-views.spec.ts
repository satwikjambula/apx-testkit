/**
 * GENERATED by apx-testgen from pages/p00090-page-views.apx — DO NOT EDIT.
 ...
 * (./p00090-page-views.page.js), not raw testkit calls, so both stay in sync.
...
import { PageViewsPage } from './p00090-page-views.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 90: Page Views [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new PageViewsPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P90_TIMEFRAME']);
  });
