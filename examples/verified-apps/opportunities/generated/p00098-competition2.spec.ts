 ...
 * (./p00098-competition2.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: button-bar, competition
...
import { Competition2Page } from './p00098-competition2.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 98: Competition [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new Competition2Page(page);
