/**
 * GENERATED by apx-testgen from pages/p00148-preferences.apx — DO NOT EDIT.
 ...
 * (./p00148-preferences.page.js), not raw testkit calls, so both stay in sync.
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), preferences (list).
...
import { PreferencesPage } from './p00148-preferences.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 148: Preferences [requires auth]', () => {
