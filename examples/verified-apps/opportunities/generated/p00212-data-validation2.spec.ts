 ...
 * (./p00212-data-validation2.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, data-load-process-train, data-validation
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), data-load-process-train (list), data-validation (classicReport).
...
import { DataValidation2Page } from './p00212-data-validation2.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 212: Data Validation [requires auth]', () => {
