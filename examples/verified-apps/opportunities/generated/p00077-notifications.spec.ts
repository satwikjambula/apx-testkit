/**
 * GENERATED by apx-testgen from pages/p00077-notifications.apx — DO NOT EDIT.
 ...
 * (./p00077-notifications.page.js), not raw testkit calls, so both stay in sync.
...
import { NotificationsPage } from './p00077-notifications.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 77: Notifications [requires auth]', () => {
