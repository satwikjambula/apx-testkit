/**
 * GENERATED by apx-testgen from pages/p00151-access-control-configuration2.apx — DO NOT EDIT.
 ...
 * (./p00151-access-control-configuration2.page.js), not raw testkit calls, so both stay in sync.
...
import { AccessControlConfiguration2Page } from './p00151-access-control-configuration2.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 151: Access Control Configuration [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (4 items, 1 hidden)', async ({ page }) => {
    const po = new AccessControlConfiguration2Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P151_ACCESS_CONTROL_SCOPE', 'P151_AC_ENABLED', 'P151_HIDDEN_AC_ENABLED', 'P151_USERNAME_FORMAT']);
  });
