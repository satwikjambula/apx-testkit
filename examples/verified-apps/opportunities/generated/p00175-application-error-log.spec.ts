/**
 * GENERATED by apx-testgen from pages/p00175-application-error-log.apx — DO NOT EDIT.
 ...
 * (./p00175-application-error-log.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: application-error-log
...
import { ApplicationErrorLogPage } from './p00175-application-error-log.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 175: Application Error Log [requires auth]', () => {
