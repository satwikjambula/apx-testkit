/**
 * GENERATED by apx-testgen from pages/p00092-attachments.apx — DO NOT EDIT.
 ...
 * (./p00092-attachments.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: attachments
...
import { AttachmentsPage } from './p00092-attachments.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 92: Attachments [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (3 items, 3 hidden)', async ({ page }) => {
    const po = new AttachmentsPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P92_DELETE_ID', 'P92_ENTITY_ID', 'P92_ENTITY_TYPE']);
  });
