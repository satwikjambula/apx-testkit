...
export class SupportAmounts2Page {
  static readonly alias = 'support-amounts2';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, SupportAmounts2Page.alias);
  }
  ...
  /** "Add Support Amount" */
  async clickAddAmount(): Promise<void> {
