/**
 * GENERATED by apx-testgen from pages/p00141-application-appearance.apx — DO NOT EDIT.
 ...
 * (./p00141-application-appearance.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: configure-appearance
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): configure-appearance (staticContent).
...
import { ApplicationAppearancePage } from './p00141-application-appearance.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 141: Application Appearance [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ApplicationAppearancePage(page);
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (2 items, 0 hidden)', async ({ page }) => {
    const po = new ApplicationAppearancePage(page);
    await po.goto();
    await expectItemsPresent(page, ['P141_DESKTOP_THEME_STYLE_ID', 'P141_END_USER_STYLE']);
  });
