 ...
 * (./p00140-data-validation.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, data-load-wizard-progress, data-validation
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), data-load-wizard-progress (list), data-validation (classicReport).
...
import { DataValidationPage } from './p00140-data-validation.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 140: Data Validation [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new DataValidationPage(page);
