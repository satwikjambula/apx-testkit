/**
 * GENERATED by apx-testgen from pages/p00084-agreements.apx — DO NOT EDIT.
 ...
 * (./p00084-agreements.page.js), not raw testkit calls, so both stay in sync.
...
import { AgreementsPage } from './p00084-agreements.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 84: Agreements [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new AgreementsPage(page);
