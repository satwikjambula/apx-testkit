...
export class PastDueOpportunitiesPage {
  static readonly alias = 'past-due-opportunities';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PastDueOpportunitiesPage.alias);
  }
  ...
  /** selectList, "Closing Timeframe" */
  get closingTimeframe(): ApexItem {
    return new ApexItem(this.page, 'P20_CLOSING_TIMEFRAME');
  }
