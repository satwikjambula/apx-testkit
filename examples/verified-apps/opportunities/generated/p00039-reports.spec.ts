/**
 * GENERATED by apx-testgen from pages/p00039-reports.apx — DO NOT EDIT.
 ...
 * (./p00039-reports.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: activity-reports, additional-reports, breadcrumb, exception-reports, primary-reports
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): activity-reports (list), additional-reports (list), breadcrumb (breadcrumb), exception-reports (list), primary-reports (list).
...
import { ReportsPage } from './p00039-reports.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 39: Reports [requires auth]', () => {
