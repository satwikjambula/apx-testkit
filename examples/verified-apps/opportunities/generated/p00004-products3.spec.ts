/**
 * GENERATED by apx-testgen from pages/p00004-products3.apx — DO NOT EDIT.
 ...
 * (./p00004-products3.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: products
...
import { Products3Page } from './p00004-products3.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 4: Products [requires auth]', () => {
  ...
  test('every labeled .apx button exists (2 buttons)', async ({ page }) => {
    const po = new Products3Page(page);
    await po.goto();
    await expectButtonsPresent(page, ['Create Product', 'Reset']);
  });
