...
export class RevenueByRepTitlePage {
  static readonly alias = 'revenue-by-rep-title';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, RevenueByRepTitlePage.alias);
  }
  ...
  get quarter(): ApexItem {
    return new ApexItem(this.page, 'P46_QUARTER');
  }

  /** selectList, "Territory" */
  get territory(): ApexItem {
    return new ApexItem(this.page, 'P46_TERRITORY');
  }
