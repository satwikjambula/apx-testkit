...
export class TimeZonePreferencePage {
  static readonly alias = 'time-zone-preference';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, TimeZonePreferencePage.alias);
  }
  ...
  /** selectList, "Timezone", required */
  get timezone(): ApexItem {
    return new ApexItem(this.page, 'P43_TIMEZONE');
  }
