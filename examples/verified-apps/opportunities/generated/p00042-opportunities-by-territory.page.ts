...
export class OpportunitiesByTerritoryPage {
  static readonly alias = 'opportunities-by-territory';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, OpportunitiesByTerritoryPage.alias);
  }
