 ...
 * (./p00107-account-locations.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: locations
...
import { AccountLocationsPage } from './p00107-account-locations.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 107: Account Locations [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new AccountLocationsPage(page);
