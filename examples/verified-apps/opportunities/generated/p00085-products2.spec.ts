/**
 * GENERATED by apx-testgen from pages/p00085-products2.apx — DO NOT EDIT.
 ...
 * (./p00085-products2.page.js), not raw testkit calls, so both stay in sync.
...
import { Products2Page } from './p00085-products2.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 85: Products [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 1 hidden)', async ({ page }) => {
    const po = new Products2Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P85_ID']);
  });
