 ...
 * (./p00051-competitors.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: competitors
...
import { CompetitorsPage } from './p00051-competitors.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 51: Competitors [requires auth]', () => {
