...
export class PreviousValidationsPage {
  static readonly alias = 'previous-validations';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PreviousValidationsPage.alias);
  }
  ...
  get entityId(): ApexItem {
    return new ApexItem(this.page, 'P147_ENTITY_ID');
  }

  /** hidden */
  get entityType(): ApexItem {
    return new ApexItem(this.page, 'P147_ENTITY_TYPE');
  }
}
