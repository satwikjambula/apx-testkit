/**
 * GENERATED by apx-testgen from pages/p00139-activity-calendar.apx — DO NOT EDIT.
 ...
 * (./p00139-activity-calendar.page.js), not raw testkit calls, so both stay in sync.
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): activity-calendar (calendar), breadcrumb (breadcrumb).
...
import { ActivityCalendarPage } from './p00139-activity-calendar.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 139: Activity Calendar [requires auth]', () => {
