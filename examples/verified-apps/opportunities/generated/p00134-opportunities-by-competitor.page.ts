...
export class OpportunitiesByCompetitorPage {
  static readonly alias = 'opportunities-by-competitor';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, OpportunitiesByCompetitorPage.alias);
  }
