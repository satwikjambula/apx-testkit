...
export class OpportunitiesWithNoAssignedProductsPage {
  static readonly alias = 'opportunities-with-no-assigned-products';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, OpportunitiesWithNoAssignedProductsPage.alias);
  }
