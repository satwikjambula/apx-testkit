/**
 * GENERATED by apx-testgen from pages/p00017-countries.apx — DO NOT EDIT.
 ...
 * (./p00017-countries.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: countries
...
import { CountriesPage } from './p00017-countries.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 17: Countries [requires auth]', () => {
  ...
  test('every labeled .apx button exists (2 buttons)', async ({ page }) => {
    const po = new CountriesPage(page);
    await po.goto();
    await expectButtonsPresent(page, ['Create Country', 'Reset']);
  });
