/**
 * GENERATED by apx-testgen from pages/p00130-agreements2.apx — DO NOT EDIT.
 ...
 * (./p00130-agreements2.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: agreements
...
import { Agreements2Page } from './p00130-agreements2.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 130: Agreements [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new Agreements2Page(page);
