/**
 * GENERATED by apx-testgen from pages/p00091-top-users.apx — DO NOT EDIT.
 ...
 * (./p00091-top-users.page.js), not raw testkit calls, so both stay in sync.
...
import { TopUsersPage } from './p00091-top-users.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 91: Top Users [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new TopUsersPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P91_TIMEFRAME']);
  });
