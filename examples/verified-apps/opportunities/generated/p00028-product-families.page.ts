...
export class ProductFamiliesPage {
  static readonly alias = 'product-families';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProductFamiliesPage.alias);
  }
  ...
  async clickCreateProductFamily(): Promise<void> {
