/**
 * GENERATED by apx-testgen from pages/p00019-polar.apx — DO NOT EDIT.
 ...
 * (./p00019-polar.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, breadcrumb, information, polar
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-page (staticContent), breadcrumb (breadcrumb), information (staticContent), polar (chart).
...
import { PolarPage } from './p00019-polar.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 19: Polar [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new PolarPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Polar'));
  });
});
