...
export class DeclarativeFontFormattingPage {
  static readonly alias = 'declarative-font-formatting';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, DeclarativeFontFormattingPage.alias);
  }
