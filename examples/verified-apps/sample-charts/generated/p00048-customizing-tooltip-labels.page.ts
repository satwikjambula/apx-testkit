...
export class CustomizingTooltipLabelsPage {
  static readonly alias = 'customizing-tooltip-labels';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CustomizingTooltipLabelsPage.alias);
  }
