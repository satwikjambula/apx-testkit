...
export class EmployeesReportPage {
  static readonly alias = 'employees-report';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, EmployeesReportPage.alias);
  }
  ...
  /** hidden */
  get deptno(): ApexItem {
    return new ApexItem(this.page, 'P29_DEPTNO');
  }
}
