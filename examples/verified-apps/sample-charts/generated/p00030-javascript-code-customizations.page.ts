...
export class JavascriptCodeCustomizationsPage {
  static readonly alias = 'javascript-code-customizations';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, JavascriptCodeCustomizationsPage.alias);
  }
