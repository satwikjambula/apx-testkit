/**
 * GENERATED by apx-testgen from pages/p00041-box-plot.apx — DO NOT EDIT.
...
import { BoxPlotPage } from './p00041-box-plot.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 41: Box Plot [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new BoxPlotPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Box Plot'));
  });
});
