...
export class PyramidPage {
  static readonly alias = 'pyramid';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, PyramidPage.alias);
  }
  ...
  /** "2D" */
  async click2d(): Promise<void> {
    await buttonByLabel(this.page, '2D').click();
  }

  /** "3D" */
  async click3d(): Promise<void> {
    await buttonByLabel(this.page, '3D').click();
  }
}
