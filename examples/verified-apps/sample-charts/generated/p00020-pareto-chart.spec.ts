/**
 * GENERATED by apx-testgen from pages/p00020-pareto-chart.apx — DO NOT EDIT.
 ...
 * (./p00020-pareto-chart.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: about-this-page, pareto-chart, pareto-chart-information
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): about-this-page (staticContent), pareto-chart (chart), pareto-chart-information (staticContent).
...
import { ParetoChartPage } from './p00020-pareto-chart.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 20: Pareto Chart [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ParetoChartPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new ParetoChartPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Pareto Chart'));
  });
});
