/**
 * GENERATED by apx-testgen from pages/p00043-pyramid.apx — DO NOT EDIT.
...
test.describe('page 43: Pyramid [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new PyramidPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Pyramid'));
  });
});
