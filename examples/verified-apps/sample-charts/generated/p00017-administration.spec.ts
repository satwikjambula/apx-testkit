/**
 * GENERATED by apx-testgen from pages/p00017-administration.apx — DO NOT EDIT.
 ...
 * (./p00017-administration.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: administration, breadcrumb
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Region types NOT covered by an auto-generated assertion (no verified DOM convention, or a runtime id genuinely unconstructible from static data -- see docs/grammar-assumptions.md "Still open" and ADR-003): administration (list), breadcrumb (breadcrumb).
...
import { AdministrationPage } from './p00017-administration.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 17: Administration [requires auth]', () => {
