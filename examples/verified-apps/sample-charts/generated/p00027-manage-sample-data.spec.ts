/**
 * GENERATED by apx-testgen from pages/p00027-manage-sample-data.apx — DO NOT EDIT.
 ...
 * (./p00027-manage-sample-data.page.js), not raw testkit calls, so both stay in sync.
...
import { ManageSampleDataPage } from './p00027-manage-sample-data.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 27: Manage Sample Data [requires auth]', () => {
