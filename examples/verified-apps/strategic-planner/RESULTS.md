# strategic-planner — verification results
...
- `classicReport`: 158
- `breadcrumb`: 119
- `interactiveReport`: 88
- `dynamicContent`: 75
- `form`: 62
- `themeTemplateComponent/contentRow`: 58
- `facetedSearch`: 34
- `list`: 10
- `regionDisplaySelector`: 9
- `cards`: 6
- `plSqlDynamicContent`: 4
- `calendar`: 3
- `chart`: 3
- `listView`: 2
- `appTemplateComponent/contentRowSimple`: 2
- `themeTemplateComponent/comments`: 2
...
in `raw` bags, nothing lost (ADR-001): `action`, `axis`, `branch`, `column`, `computation`, `facet`, `pageGroup`, `process`, `savedReport`, `series`, `validation`

## Generation

`@apx/testgen` produced **261** page object + smoke spec pairs
(260 marked skip: auth required). See `generated/` for
the actual files.
...
**0 added, 0 removed, 0 changed, 261 unchanged** — confirms zero spurious differences.
