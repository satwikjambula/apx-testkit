/**
 * GENERATED by apx-testgen from pages/p00086-projects-ir.apx — DO NOT EDIT.
 ...
 * (./p00086-projects-ir.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, menubar, projects-interactive-report
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), menubar (themeTemplateComponent/contentRow).
...
import { ProjectsIrPage } from './p00086-projects-ir.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 86: Projects [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ProjectsIrPage(page);
  ...
  test('every interactiveReport/cards/facetedSearch region resolves (1 region)', async ({ page }) => {
    const po = new ProjectsIrPage(page);
    await po.goto();
    await expectRegionsResolve(page, ['projects-interactive-report']);
  });
});
