/**
 * GENERATED by apx-testgen from pages/p00019-people-details.apx — DO NOT EDIT.
 ...
 * (./p00019-people-details.page.js), not raw testkit calls, so both stay in sync.
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), filters (staticContent), menubar (themeTemplateComponent/contentRow), users (classicReport).
...
import { PeopleDetailsPage } from './p00019-people-details.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 19: People Details [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new PeopleDetailsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new PeopleDetailsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('&NOMENCLATURE_USERS. Details'));
  });
