...
export class ConfigureApplicationFeaturesPage {
  static readonly alias = 'configure-application-features';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ConfigureApplicationFeaturesPage.alias);
  }
