...
export class ReleaseMilestoneDefaultTagsPage {
  static readonly alias = 'release-milestone-default-tags';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReleaseMilestoneDefaultTagsPage.alias);
  }
  ...
  /** "Add Release Milestone Default Tag" */
  async clickCreate(): Promise<void> {
    await buttonByLabel(this.page, 'Add Release Milestone Default Tag').click();
  }
