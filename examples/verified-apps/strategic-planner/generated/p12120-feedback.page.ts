...
export class FeedbackPage {
  ...
  /** hidden */
  get appId(): ApexItem {
    return new ApexItem(this.page, 'P12120_APP_ID');
  }

  /** textarea, "Feedback" */
  get feedback(): ApexItem {
    return new ApexItem(this.page, 'P12120_FEEDBACK');
  }

  /** hidden */
  get pageId(): ApexItem {
    return new ApexItem(this.page, 'P12120_PAGE_ID');
  }

  /** radioGroup, "Experience" */
  get rating(): ApexItem {
    return new ApexItem(this.page, 'P12120_RATING');
  }
