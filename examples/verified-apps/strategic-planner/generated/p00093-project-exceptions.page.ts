...
export class ProjectExceptionsPage {
  static readonly alias = 'project-exceptions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectExceptionsPage.alias);
  }
  ...
  get projectId(): ApexItem {
    return new ApexItem(this.page, 'P93_PROJECT_ID');
  }
}
