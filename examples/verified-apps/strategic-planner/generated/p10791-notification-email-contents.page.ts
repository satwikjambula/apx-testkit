...
export class NotificationEmailContentsPage {
  static readonly alias = 'notification-email-contents';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, NotificationEmailContentsPage.alias);
  }
  ...
  /** hidden */
  get id(): ApexItem {
    return new ApexItem(this.page, 'P10791_ID');
  }
}
