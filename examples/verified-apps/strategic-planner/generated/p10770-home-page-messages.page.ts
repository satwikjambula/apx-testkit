...
export class HomePageMessagesPage {
  static readonly alias = 'home-page-messages';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, HomePageMessagesPage.alias);
  }
  ...
  async clickCreate(): Promise<void> {
    await buttonByLabel(this.page, 'Add Message').click();
  }
