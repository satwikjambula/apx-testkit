...
export class InitiativeViewsPage {
  static readonly alias = 'initiative-views';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, InitiativeViewsPage.alias);
  }
  ...
  get orderBy(): ApexItem {
    return new ApexItem(this.page, 'P81_ORDER_BY');
  }
