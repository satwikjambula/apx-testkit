/**
 * GENERATED by apx-testgen from pages/p00017-focus-areas.apx — DO NOT EDIT.
 ...
 * (./p00017-focus-areas.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, faceted-search, menubar, nomenclature-areas, sort-container
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), menubar (themeTemplateComponent/contentRow), nomenclature-areas (themeTemplateComponent/contentRow), sort-container (staticContent).
...
import { FocusAreasPage } from './p00017-focus-areas.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 17: Focus Areas [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new FocusAreasPage(page);
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new FocusAreasPage(page);
    await po.goto();
    await expectItemsPresent(page, ['P17_ORDER_BY']);
  });
