...
export class ArchivedNomenclatureProjectsPage {
  static readonly alias = 'archived-nomenclature-projects';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ArchivedNomenclatureProjectsPage.alias);
  }
