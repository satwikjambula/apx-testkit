...
export class ProjectGroups1Page {
  static readonly alias = 'project-groups1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectGroups1Page.alias);
  }
  ...
  /** hidden */
  get projectGroup(): ApexItem {
    return new ApexItem(this.page, 'P119_PROJECT_GROUP');
  }

  /** hidden */
  get projectGroupId(): ApexItem {
    return new ApexItem(this.page, 'P119_PROJECT_GROUP_ID');
  }
