...
export class CommentsFilterReportPage {
  static readonly alias = 'comments-filter-report';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CommentsFilterReportPage.alias);
  }
  ...
  /** "Interactive Report" */
  async clickInteractiveReport(): Promise<void> {
    await buttonByLabel(this.page, 'Interactive Report').click();
  }
