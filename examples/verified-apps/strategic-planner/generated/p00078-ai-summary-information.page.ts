...
export class AiSummaryInformationPage {
  static readonly alias = 'ai-summary-information';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AiSummaryInformationPage.alias);
  }
  ...
  /** hidden */
  get type(): ApexItem {
    return new ApexItem(this.page, 'P78_TYPE');
  }
}
