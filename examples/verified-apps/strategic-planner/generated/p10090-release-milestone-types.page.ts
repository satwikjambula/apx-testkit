...
export class ReleaseMilestoneTypesPage {
  static readonly alias = 'release-milestone-types';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReleaseMilestoneTypesPage.alias);
  }
  ...
  /** "Add Release Milestone Type" */
  async clickCreate(): Promise<void> {
    await buttonByLabel(this.page, 'Add Release Milestone Type').click();
  }
