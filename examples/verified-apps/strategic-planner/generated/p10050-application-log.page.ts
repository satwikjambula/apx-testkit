...
export class ApplicationLogPage {
  static readonly alias = 'application-log';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ApplicationLogPage.alias);
  }
  ...
  /** "Purge Log" */
  async clickPurgeLog(): Promise<void> {
    await buttonByLabel(this.page, 'Purge Log').click();
  }
