...
export class ReleaseChangeHistoryOldPage {
  static readonly alias = 'release-change-history-old';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReleaseChangeHistoryOldPage.alias);
  }
  ...
  get release(): ApexItem {
    return new ApexItem(this.page, 'P14_RELEASE');
  }

  /** hidden */
  get releaseId(): ApexItem {
    return new ApexItem(this.page, 'P14_RELEASE_ID');
  }
