/**
 * GENERATED by apx-testgen from pages/p00129-developer-detail-views.apx — DO NOT EDIT.
 ...
 * (./p00129-developer-detail-views.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, button-bar, menubar, search, search-results
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), button-bar (staticContent), menubar (themeTemplateComponent/contentRow), search-results (classicReport).
...
import { DeveloperDetailViewsPage } from './p00129-developer-detail-views.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 129: Developer Detail Views [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new DeveloperDetailViewsPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new DeveloperDetailViewsPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Developer Detail Views (31 Days)'));
  });
