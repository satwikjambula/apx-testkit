/**
 * GENERATED by apx-testgen from pages/p00123-screen-names1.apx — DO NOT EDIT.
 ...
 * (./p00123-screen-names1.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: search, users
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): users (themeTemplateComponent/contentRow).
...
import { ScreenNames1Page } from './p00123-screen-names1.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 123: Screen Names [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ScreenNames1Page(page);
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (1 items, 0 hidden)', async ({ page }) => {
    const po = new ScreenNames1Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P123_REQUIRE_SCREEN_NAME']);
  });
