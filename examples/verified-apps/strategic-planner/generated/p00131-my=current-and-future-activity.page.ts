...
export class MyCurrentAndFutureActivityPage {
  static readonly alias = 'my=current-and-future-activity';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, MyCurrentAndFutureActivityPage.alias);
  }
