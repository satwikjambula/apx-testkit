...
export class CommentsIrPage {
  static readonly alias = 'comments-ir';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CommentsIrPage.alias);
  }
  ...
  /** "Filter Report" */
  async clickFilterReport(): Promise<void> {
    await buttonByLabel(this.page, 'Filter Report').click();
  }
