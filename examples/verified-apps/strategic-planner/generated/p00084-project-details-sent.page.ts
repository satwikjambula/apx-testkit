...
export class ProjectDetailsSentPage {
  static readonly alias = 'project-details-sent';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectDetailsSentPage.alias);
  }
  ...
  /** hidden */
  get id(): ApexItem {
    return new ApexItem(this.page, 'P84_ID');
  }
}
