/**
 * GENERATED by apx-testgen from pages/p00065-tasks-ir.apx — DO NOT EDIT.
 ...
 * (./p00065-tasks-ir.page.js), not raw testkit calls, so both stay in sync.
...
import { TasksIrPage } from './p00065-tasks-ir.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 65: Milestones, Reviews and Tasks [requires auth]', () => {
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new TasksIrPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('&NOMENCLATURE_PROJECT. Milestones, Reviews and Tasks'));
  });
