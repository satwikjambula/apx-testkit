...
export class LinksFromCommentsPage {
  static readonly alias = 'links-from-comments';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, LinksFromCommentsPage.alias);
  }
  ...
  /** "Add Links" */
  async clickAddLinks(): Promise<void> {
