/**
 * GENERATED by apx-testgen from pages/p00147-my-approval-configuration.apx — DO NOT EDIT.
 ...
 * (./p00147-my-approval-configuration.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: configuration
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): configuration (classicReport).
...
import { MyApprovalConfigurationPage } from './p00147-my-approval-configuration.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 147: My Approval Configuration [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new MyApprovalConfigurationPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new MyApprovalConfigurationPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('My Approval Configuration'));
  });
});
