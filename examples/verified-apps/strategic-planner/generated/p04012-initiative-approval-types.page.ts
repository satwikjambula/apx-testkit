...
export class InitiativeApprovalTypesPage {
  static readonly alias = 'initiative-approval-types';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, InitiativeApprovalTypesPage.alias);
  }
  ...
  async clickCreate(): Promise<void> {
    await buttonByLabel(this.page, 'Add Type').click();
  }
