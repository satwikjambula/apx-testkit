...
export class ManageArchivedNomenclatureProjectsPage {
  static readonly alias = 'manage-archived-nomenclature-projects';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ManageArchivedNomenclatureProjectsPage.alias);
  }
