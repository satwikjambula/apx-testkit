...
export class AddInitiativeCompletenessScalePage {
  static readonly alias = 'add-initiative-completeness-scale';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AddInitiativeCompletenessScalePage.alias);
  }
  ...
  get statusScale(): ApexItem {
    return new ApexItem(this.page, 'P171_STATUS_SCALE');
  }
