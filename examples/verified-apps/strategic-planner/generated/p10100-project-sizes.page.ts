...
export class ProjectSizesPage {
  static readonly alias = 'project-sizes';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectSizesPage.alias);
  }
  ...
  /** "Add Size" */
  async clickAddSize(): Promise<void> {
    await buttonByLabel(this.page, 'Add Size').click();
  }
