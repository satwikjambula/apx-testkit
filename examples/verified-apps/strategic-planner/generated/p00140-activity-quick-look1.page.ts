...
export class ActivityQuickLook1Page {
  static readonly alias = 'activity-quick-look1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ActivityQuickLook1Page.alias);
  }
  ...
  /** hidden */
  get id(): ApexItem {
    return new ApexItem(this.page, 'P140_ID');
  }
}
