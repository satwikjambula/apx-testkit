...
export class ProjectDefaultTagsPage {
  static readonly alias = 'project-default-tags';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectDefaultTagsPage.alias);
  }
  ...
  /** textField, "Add Tag" */
  get addTag(): ApexItem {
    return new ApexItem(this.page, 'P10500_ADD_TAG');
  }
