...
export class FocusAreasPage {
  static readonly alias = 'focus-areas';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, FocusAreasPage.alias);
  }
  ...
  get orderBy(): ApexItem {
    return new ApexItem(this.page, 'P17_ORDER_BY');
  }
