/**
 * GENERATED by apx-testgen from pages/p00041-reports.apx — DO NOT EDIT.
 ...
 * (./p00041-reports.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, reports-from-list
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): breadcrumb (breadcrumb), reports-from-list (list).
...
import { ReportsPage } from './p00041-reports.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 41: Reports [requires auth]', () => {
