/**
 * GENERATED by apx-testgen from pages/p00145-groups1.apx — DO NOT EDIT.
 ...
 * (./p00145-groups1.page.js), not raw testkit calls, so both stay in sync.
...
import { Groups1Page } from './p00145-groups1.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 145: Groups [requires auth]', () => {
