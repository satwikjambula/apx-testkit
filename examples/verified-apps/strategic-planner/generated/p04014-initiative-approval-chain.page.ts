...
export class InitiativeApprovalChainPage {
  static readonly alias = 'initiative-approval-chain';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, InitiativeApprovalChainPage.alias);
  }
  ...
  async clickCreate(): Promise<void> {
    await buttonByLabel(this.page, 'Add Entry').click();
  }
