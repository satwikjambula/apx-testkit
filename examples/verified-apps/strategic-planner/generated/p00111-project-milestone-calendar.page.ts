...
export class ProjectMilestoneCalendarPage {
  static readonly alias = 'project-milestone-calendar';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectMilestoneCalendarPage.alias);
  }
