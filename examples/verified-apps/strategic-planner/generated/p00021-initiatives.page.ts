...
export class InitiativesPage {
  static readonly alias = 'initiatives';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, InitiativesPage.alias);
  }
  ...
  /** hidden */
  get defaultAreaId(): ApexItem {
    return new ApexItem(this.page, 'P21_DEFAULT_AREA_ID');
  }

  /** selectList, "Order By", required */
  get orderBy(): ApexItem {
    return new ApexItem(this.page, 'P21_ORDER_BY');
  }
