...
export class CrossReleaseCalendarPage {
  static readonly alias = 'cross-release-calendar';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, CrossReleaseCalendarPage.alias);
  }
  ...
  get release(): ApexItem {
    return new ApexItem(this.page, 'P55_RELEASE');
  }

  /** hidden */
  get releaseId(): ApexItem {
    return new ApexItem(this.page, 'P55_RELEASE_ID');
  }
