...
export class ProjectCompletenessScalesPage {
  static readonly alias = 'project-completeness-scales';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectCompletenessScalesPage.alias);
  }
