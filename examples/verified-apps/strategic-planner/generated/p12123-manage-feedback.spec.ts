/**
 * GENERATED by apx-testgen from pages/p12123-manage-feedback.apx — DO NOT EDIT.
 ...
 * (./p12123-manage-feedback.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, manage-feedback
...
import { ManageFeedbackPage } from './p12123-manage-feedback.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 12123: Manage Feedback [requires auth]', () => {
  ...
  test('every interactiveReport/cards/facetedSearch region resolves (1 region)', async ({ page }) => {
    const po = new ManageFeedbackPage(page);
    await po.goto();
    await expectRegionsResolve(page, ['manage-feedback']);
  });
});
