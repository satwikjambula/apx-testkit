/**
 * GENERATED by apx-testgen from pages/p00111-project-milestone-calendar.apx — DO NOT EDIT.
 ...
 * (./p00111-project-milestone-calendar.page.js), not raw testkit calls, so both stay in sync.
...
import { ProjectMilestoneCalendarPage } from './p00111-project-milestone-calendar.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 111: Project Milestone Calendar [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ProjectMilestoneCalendarPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new ProjectMilestoneCalendarPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('Project Milestone Calendar'));
  });
