/**
 * GENERATED by apx-testgen from pages/p00138-my-projects-home-page.apx — DO NOT EDIT.
 ...
 * (./p00138-my-projects-home-page.page.js), not raw testkit calls, so both stay in sync.
...
import { MyProjectsHomePagePage } from './p00138-my-projects-home-page.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 138: My Projects [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new MyProjectsHomePagePage(page);
