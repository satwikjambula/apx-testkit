...
export class AddMultiplePeoplePage {
  static readonly alias = 'add-multiple-people';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AddMultiplePeoplePage.alias);
  }
  ...
  /** textarea, "&NOMENCLATURE_USERS.", required */
  get prelimUsers(): ApexItem {
    return new ApexItem(this.page, 'P54_PRELIM_USERS');
  }
