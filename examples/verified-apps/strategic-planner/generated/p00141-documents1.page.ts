...
export class Documents1Page {
  static readonly alias = 'documents1';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, Documents1Page.alias);
  }
  ...
  /** hidden */
  get id(): ApexItem {
    return new ApexItem(this.page, 'P141_ID');
  }

  /** hidden */
  get projectId(): ApexItem {
    return new ApexItem(this.page, 'P141_PROJECT_ID');
  }
