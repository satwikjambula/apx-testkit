...
export class ReleaseDashboardPage {
  static readonly alias = 'release-dashboard';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ReleaseDashboardPage.alias);
  }
  ...
  get release(): ApexItem {
    return new ApexItem(this.page, 'P202_RELEASE');
  }

  /** hidden */
  get releaseId(): ApexItem {
    return new ApexItem(this.page, 'P202_RELEASE_ID');
  }
