/**
 * GENERATED by apx-testgen from pages/p12150-settings.apx — DO NOT EDIT.
 ...
 * (./p12150-settings.page.js), not raw testkit calls, so both stay in sync.
...
import { SettingsPage } from './p12150-settings.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 12150: Settings [requires auth]', () => {
  ...
  test('every labeled .apx button exists (3 buttons)', async ({ page }) => {
    const po = new SettingsPage(page);
    await po.goto();
    await expectButtonsPresent(page, ['Reset', 'Apply Changes', 'Up']);
  });
});
