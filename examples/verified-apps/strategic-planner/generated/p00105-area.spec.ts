/**
 * GENERATED by apx-testgen from pages/p00105-area.apx — DO NOT EDIT.
 ...
 * (./p00105-area.page.js), not raw testkit calls, so both stay in sync.
...
import { AreaPage } from './p00105-area.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 105: Area [requires auth]', () => {
  ...
  test('every labeled .apx button exists (4 buttons)', async ({ page }) => {
    const po = new AreaPage(page);
    await po.goto();
    await expectButtonsPresent(page, ['About &NOMENCLATURE_PROJECTS.', 'About Releases', 'About Activities', 'About &NOMENCLATURE_INITIATIVES.']);
  });
});
