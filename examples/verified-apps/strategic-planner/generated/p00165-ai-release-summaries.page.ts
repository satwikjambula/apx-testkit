...
export class AiReleaseSummariesPage {
  static readonly alias = 'ai-release-summaries';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AiReleaseSummariesPage.alias);
  }
  ...
  get releaseId(): ApexItem {
    return new ApexItem(this.page, 'P165_RELEASE_ID');
  }

  /** "Generate Summary" */
  async clickGenerate(): Promise<void> {
    await buttonByLabel(this.page, 'Generate Summary').click();
  }
