 ...
 * (./p00109-user.page.js), not raw testkit calls, so both stay in sync.
...
import { UserPage } from './p00109-user.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 109: User [requires auth]', () => {
