/**
 * GENERATED by apx-testgen from pages/p00067-contributor-roles.apx — DO NOT EDIT.
 ...
 * (./p00067-contributor-roles.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: contributor-roles
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): contributor-roles (classicReport).
...
import { ContributorRolesPage } from './p00067-contributor-roles.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 67: Contributor_roles [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new ContributorRolesPage(page);
