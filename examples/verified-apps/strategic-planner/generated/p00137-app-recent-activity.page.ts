...
export class AppRecentActivityPage {
  static readonly alias = 'app-recent-activity';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AppRecentActivityPage.alias);
  }
  ...
  /** selectList, "Days" */
  get days(): ApexItem {
    return new ApexItem(this.page, 'P137_DAYS');
  }
}
