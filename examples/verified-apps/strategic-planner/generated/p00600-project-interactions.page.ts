...
export class ProjectInteractionsPage {
  static readonly alias = 'project-interactions';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectInteractionsPage.alias);
  }
  ...
  get projectId(): ApexItem {
    return new ApexItem(this.page, 'P600_PROJECT_ID');
  }

  /** "Details" */
  async clickViewDetails(): Promise<void> {
    await buttonByLabel(this.page, 'Details').click();
  }
}
