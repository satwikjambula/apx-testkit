...
export class ApprovalTypesPage {
  static readonly alias = 'approval-types';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ApprovalTypesPage.alias);
  }
  ...
  async clickCreate(): Promise<void> {
    await buttonByLabel(this.page, 'Add Approval Type').click();
  }
