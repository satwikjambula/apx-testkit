/**
 * GENERATED by apx-testgen from pages/p00146-links-ir.apx — DO NOT EDIT.
 ...
 * (./p00146-links-ir.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: breadcrumb, links-interactive-report
...
import { LinksIrPage } from './p00146-links-ir.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 146: Links [requires auth]', () => {
  ...
  test('every interactiveReport/cards/facetedSearch region resolves (1 region)', async ({ page }) => {
    const po = new LinksIrPage(page);
    await po.goto();
    await expectRegionsResolve(page, ['links-interactive-report']);
  });
});
