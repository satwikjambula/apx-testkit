/**
 * GENERATED by apx-testgen from pages/p00034-size.apx — DO NOT EDIT.
 ...
 * (./p00034-size.page.js), not raw testkit calls, so both stay in sync.
 * Regions present in metadata: size
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): size (dynamicContent).
...
import { SizePage } from './p00034-size.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 34: Size [requires auth]', () => {
