/**
 * GENERATED by apx-testgen from pages/p00131-my=current-and-future-activity.apx — DO NOT EDIT.
 ...
 * (./p00131-my=current-and-future-activity.page.js), not raw testkit calls, so both stay in sync.
 ...
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): about (dynamicContent).
...
import { MyCurrentAndFutureActivityPage } from './p00131-my=current-and-future-activity.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 131: My Activities [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new MyCurrentAndFutureActivityPage(page);
  ...
  test('title matches metadata (normalized)', async ({ page }) => {
    const po = new MyCurrentAndFutureActivityPage(page);
    await po.goto();
    expect(normalizeTitle(await page.title())).toBe(normalizeTitle('My Activities'));
  });
});
