...
export class AddInitiativeConfirmPage {
  static readonly alias = 'add-initiative-confirm';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AddInitiativeConfirmPage.alias);
  }
  ...
  /** hidden */
  get newInitiativeId(): ApexItem {
    return new ApexItem(this.page, 'P175_NEW_INITIATIVE_ID');
  }
