...
export class TeamMemberDefaultTagsPage {
  static readonly alias = 'team-member-default-tags';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, TeamMemberDefaultTagsPage.alias);
  }
  ...
  /** textField, "Add Tag" */
  get addTag(): ApexItem {
    return new ApexItem(this.page, 'P10520_ADD_TAG');
  }

  /** "Add Tag" */
  async clickAddTag(): Promise<void> {
    await buttonByLabel(this.page, 'Add Tag').click();
  }
