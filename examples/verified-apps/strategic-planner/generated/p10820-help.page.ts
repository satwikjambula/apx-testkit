...
export class HelpPage {
  static readonly alias = 'help';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, HelpPage.alias);
  }
  ...
  /** "View Percent Complete Scales" */
  async clickViewPercentCompleteScales(): Promise<void> {
    await buttonByLabel(this.page, 'View Percent Complete Scales').click();
  }
}
