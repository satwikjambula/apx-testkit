...
export class AllNomenclatureProjectApprovalsPage {
  static readonly alias = 'all-nomenclature-project-approvals';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, AllNomenclatureProjectApprovalsPage.alias);
  }
