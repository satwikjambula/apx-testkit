/**
 * GENERATED by apx-testgen from pages/p00156-documents-ir.apx — DO NOT EDIT.
 ...
 * (./p00156-documents-ir.page.js), not raw testkit calls, so both stay in sync.
...
import { DocumentsIrPage } from './p00156-documents-ir.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 156: Documents [requires auth]', () => {
  ...
  test('loads via alias URL with clean console' , async ({ page }) => {
    const po = new DocumentsIrPage(page);
