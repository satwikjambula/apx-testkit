...
export class ProjectInteractionsAllPage {
  static readonly alias = 'project-interactions-all';

  constructor(private readonly page: Page) {}

  url(): string {
    return apexPageUrl(APP_BASE, ProjectInteractionsAllPage.alias);
  }
  ...
  get projectId(): ApexItem {
    return new ApexItem(this.page, 'P610_PROJECT_ID');
  }

  /** "Reset" */
  async clickResetPage(): Promise<void> {
