 ...
 * Regions present in metadata: buttons, wizard-container
 * No interactiveReport/cards/facetedSearch regions on this page -- no region resolve-check to emit.
 * Other region types NOT covered by an auto-generated assertion (no verified DOM convention -- see docs/grammar-assumptions.md "Still open"): buttons (staticContent), wizard-container (staticContent).
...
test.describe('page 10033: Add Multiple Users - Step 1 [requires auth]', () => {
  ...
  test('every .apx pageItem exists in DOM/apex.item registry (3 items, 0 hidden)', async ({ page }) => {
    const po = new AddMultipleUsersStep1Page(page);
    await po.goto();
    await expectItemsPresent(page, ['P10033_PRELIM_USERS', 'P10033_ROLE', 'P10033_SEND_EMAIL_YN']);
  });
