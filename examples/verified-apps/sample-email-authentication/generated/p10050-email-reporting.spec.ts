/**
 * GENERATED by apx-testgen from pages/p10050-email-reporting.apx — DO NOT EDIT.
 ...
 * (./p10050-email-reporting.page.js), not raw testkit calls, so both stay in sync.
...
import { EmailReportingPage } from './p10050-email-reporting.page.js';
import { APP_BASE } from '../playwright.config.js';

test.describe('page 10050: Email Reporting [requires auth]', () => {
