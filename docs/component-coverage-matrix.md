...
| `calendar` | 3/13 | 25 | Not verified — `Calendar` stub, zero live ground truth |
...
- **Typed-but-unverified** (Dynamic Actions): a new category this round
  introduced — real, structured metadata with zero runtime capability
  behind it yet. Don't conflate "the parser understands this" with "the
  testkit can act on this."
